...
style:"DEFAULT"},scaleControl:!0,scaleControlOptions:{position:"BOTTOM_LEFT",style:"DEFAULT"},scrollwheel:!0,streetViewControl:!0,streetViewControlOptions:{position:"LEFT_TOP"},zoom:4,zoomControl:!0,zoomControlOptions:{style:"LARGE",position:"LEFT_TOP"},notfound:"\u627e\u4e0d\u5230\u67e5\u8a62\u7684\u5730\u9ede",loading:"\u8b80\u53d6\u4e2d&hellip;",kml:{url:"",viewport:!0,infowindow:!1},interval:200,event:null,showStreetView:!1,autoLocation:!0},n=0,q=0;p.prototype=new google.maps.OverlayView;p.prototype.onAdd=
function(){var b=this.getPanes().overlayLayer;this.div.appendTo(m(b));this.listeners=[google.maps.event.addListener(this,"visible_changed",this.onRemove)]};p.prototype.draw=function(){var b=this.getProjection(),a={};try{a=b.fromLatLngToDivPixel(this.get("position")),this.div.css({left:a.x+"px",top:a.y+"px",display:"block"}),this.text&&this.span.html(this.text.toString())}catch(d){}};p.prototype.onRemove=function(){m(this.div).remove()};s.prototype={VERSION:"2.8.2",_polylines:[],_polygons:[],_circles:[],
_kmls:[],_directions:[],bounds:new google.maps.LatLngBounds,setZoom:function(b,a){f(a,"zoom")&&b&&b.setZoom(a.zoom)},kml:function(b,a){var d={},c="",d={};a=a?a:this.options;h!==a.kml&&(d={preserveViewport:!0,suppressInfoWindows:!1},c="string"===typeof a.kml&&0!==a.kml.length?a.kml:h!==a.kml.url?a.kml.url:"",d=new google.maps.KmlLayer(c,m.extend(d,a.kml)),this._kmls.push(d),d.setMap(b))},direction:function(b,a){var d="";a=a?a:this.options;if(h!==a.direction&&0<a.direction.length)for(d in a.direction)f(a.direction,
d)&&h!==a.direction[d]&&this.directionService(a.direction[d])},markers:function(b,a,d){var c="",e=0,k=0,l=[],g=[];a=a?a:this.options;q=n=0;l=this._markers;if((!d||0===l.length)&&h!==a.marker&&0<a.marker.length)for(c in a.marker)f(a.marker,c)&&f(a.marker[c],"addr")&&("object"===typeof a.marker[c].addr&&2===a.marker[c].addr.length?this.markerDirect(b,a.marker[c],a):"string"===typeof a.marker[c].addr&&this.markerByGeocoder(b,a.marker[c],a));if("modify"===d)for(g=this._labels,e=0;e<a.marker.length;e+=
1)if(h!==a.marker[e].id){for(k=0;k<l.length;k+=1)a.marker[e].id===l[k].id&&h!==a.marker[e].addr&&(l[k].setPosition(new google.maps.LatLng(a.marker[e].addr[0],a.marker[e].addr[1])),"function"===typeof l[e].infoWindow.setContent&&l[k].infoWindow.setContent(a.marker[e].text));for(k=0;k<g.length;k+=1)a.marker[e].id===g[k].id&&(f(a.marker[e],"label")&&(g[k].text=a.marker[e].label),g[k].draw())}else"object"===typeof a.marker[e].addr&&2===a.marker[e].addr.length?this.markerDirect(b,a.marker[e]):"string"===
