...
C={autoLocation:!1,center:[24,121],infoWindowAutoClose:!0,interval:200,loading:"\u8b80\u53d6\u4e2d&hellip;",notFound:"\u627e\u4e0d\u5230\u67e5\u8a62\u7684\u5730\u9ede",zoom:8},y={},y={greyscale:[{featureType:"all",stylers:[{saturation:-100},{gamma:.5}]}]};x.prototype={VERSION:"3.2.18",formatSize:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Size(a[0],a[1]):a},formatPoint:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Point(a[0],a[1]):a},overlay:function(){var a=
...
Array.isArray(h.pixelOffset)&&(h.pixelOffset=this.formatSize(h.pixelOffset))),l.text=f,l.infoWindow=new google.maps.InfoWindow(h));k.isEmptyObject(g)||(l.icon=g);b.hasOwnProperty("animation")&&"string"===typeof b.animation&&(l.animation=google.maps.Animation[b.animation.toUpperCase()]);l=k.extend({},b,l);c="function"===typeof MarkerWithLabel?new MarkerWithLabel(l):new google.maps.Marker(l);this._markers.push(c);c&&b.hasOwnProperty("event")&&b.event.hasOwnProperty("created")&&"function"===typeof b.event.created&&
...
d.interval);else if(f===google.maps.GeocoderStatus.OK){var g={},h={},l=b.hasOwnProperty("id")?b.id:"",g=b.hasOwnProperty("title")?b.title.toString().replace(/<([^>]+)>/g,""):!1,p=b.hasOwnProperty("text")?b.text.toString():!1,m={map:a,position:e[0].geometry.location,animation:null,visible:!0,id:l},q=d.markerIcon(b);g&&(m.title=g);p&&(m.text=p,m.infoWindow=new google.maps.InfoWindow({content:p}));k.isEmptyObject(q)||(m.icon=q);b.hasOwnProperty("animation")&&"string"===typeof b.animation&&(m.animation=
google.maps.Animation[b.animation.toUpperCase()]);m=k.extend({},b,m);g="function"===typeof MarkerWithLabel?new MarkerWithLabel(m):new google.maps.Marker(m);d._markers.push(g);g&&b.hasOwnProperty("event")&&b.event.hasOwnProperty("created")&&"function"===typeof b.event.created&&b.event.created.call(g,d);g.hasOwnProperty("position")&&("function"===typeof g.getPosition&&d._bounds.extend(g.position),d.options.hasOwnProperty("markerFitBounds")&&!0===d.options.markerFitBounds&&d._markers.length===c.marker.length&&
a.fitBounds(d._bounds));(!b.hasOwnProperty("cluster")||b.hasOwnProperty("cluster")&&!0===b.cluster)&&"function"===typeof d._clusters.addMarker&&d._clusters.addMarker(g);b.hasOwnProperty("newLabel")&&(h=new v({text:b.newLabel,map:d.map,css:b.hasOwnProperty("newLabelCSS")?b.newLabelCSS.toString():"",id:l}),h.bindTo("position",g,"position"),h.bindTo("text",g,"position"),h.bindTo("visible",g),d._labels.push(h));google.maps.event.addListener(g,"map_changed",function(){"function"===typeof h.setMap&&h.setMap(this.getMap())});
d.bindEvents(g,b.event)}})},direction:function(a,b){var c=0;if(b.hasOwnProperty("direction")&&Array.isArray(b.direction))for(c=0;c<b.direction.length;c+=1)"undefined"!==typeof b.direction[c]&&this.directionService(b.direction[c])},directionService:function(a){if(!a.hasOwnProperty("from")||!a.hasOwnProperty("to"))return!1;var b=this,c=new google.maps.DirectionsService,d=new google.maps.DirectionsRenderer,e={},f=[],g=[],h=new google.maps.InfoWindow,l=[],p={},m="",r="",n={travelMode:google.maps.DirectionsTravelMode.DRIVING,
optimizeWaypoints:a.hasOwnProperty("optimize")?a.optimize:!0};i=0;n.origin=q(a.from,!0);n.destination=q(a.to,!0);p=k.extend({},{infoWindow:h,map:b.map},a);a.hasOwnProperty("travel")&&google.maps.TravelMode[a.travel.toString().toUpperCase()]&&(n.travelMode=google.maps.TravelMode[a.travel.toString().toUpperCase()]);a.hasOwnProperty("panel")&&k(a.panel).length&&(p.panel=k(a.panel).get(0));if(a.hasOwnProperty("waypoint")&&Array.isArray(a.waypoint)){for(i=0;i<a.waypoint.length;i+=1)e={},"string"===typeof a.waypoint[i]||
