...
a,b){var d="",e=0,g=0,e="",h=[],k=[];a=a?a:this.options;u=t=0;h=this._markers;if((!b||0===h.length)&&l.isArray(a.marker))for(d in a.marker)f(a.marker,d)&&f(a.marker[d],"addr")&&(e=p(a.marker[d].addr,!0),a.marker[d].addr=e,"string"===typeof e?this.markerByGeocoder(c,a.marker[d],a):this.markerDirect(c,a.marker[d],a));if("modify"===b)for(k=this._labels,e=0;e<a.marker.length;e+=1)if(f(a.marker[e],"id")){for(g=0;g<h.length;g+=1)a.marker[e].id===h[g].id&&f(a.marker[e],"addr")&&(h[g].setPosition(new google.maps.LatLng(a.marker[e].addr[0],
a.marker[e].addr[1])),f(a.marker[e],"text")&&(f(h[g],"infoWindow")?"function"===typeof h[g].infoWindow.setContent&&h[g].infoWindow.setContent(a.marker[e].text):(h[g].infoWindow=new google.maps.InfoWindow({content:a.marker[e].text}),this.bindEvents(h[g],a.marker[e].event))),f(a.marker[e],"icon")&&h[g].setIcon(a.marker[e].icon));for(g=0;g<k.length;g+=1)a.marker[e].id===k[g].id&&(f(a.marker[e],"label")&&(k[g].text=a.marker[e].label),k[g].draw())}else l.isArray(a.marker[e].addr)?this.markerDirect(c,a.marker[e]):
"string"===typeof a.marker[e].addr&&this.markerByGeocoder(c,a.marker[e]);if(f(a,"markerCluster")&&!0===a.markerCluster&&"function"===typeof MarkerClusterer)return new MarkerClusterer(c,this._markers)},drawPolyline:function(c,a){var b={},d=0,e="",g={},h=0,k=new google.maps.MVCArray,l=[],g={},p=[],n={};a=a?a:this.options;if(f(a,"polyline")&&f(a.polyline,"coords")){for(e in a.polyline.coords)f(a.polyline.coords,e)&&(g=a.polyline.coords,m!==g[e]&&k.push(new google.maps.LatLng(g[e][0],g[e][1])));b=new google.maps.Polyline({strokeColor:a.polyline.color||
"#FF0000",strokeOpacity:1,strokeWeight:a.polyline.width||2});this._polylines.push(b);if(2<k.getLength())for(d=0;d<k.length;d+=1)0<d&&k.getLength()-1>d&&p.push({location:k[d],stopover:!1});!0===a.polyline.snap?(g=new google.maps.DirectionsService,g.route({origin:k.getAt(0),waypoints:p,destination:k.getAt(k.getLength()-1),travelMode:google.maps.DirectionsTravelMode.DRIVING},function(c,e){if(e===google.maps.DirectionsStatus.OK){d=0;for(h=c.routes[0].overview_path.length;d<h;d+=1)l.push(c.routes[0].overview_path[d]);
b.setPath(l);"function"===typeof a.polyline.getDistance&&(n=c.routes[0].legs[0].distance,a.polyline.getDistance.call(this,n))}})):(b.setPath(k),f(google.maps.geometry,"spherical")&&"function"===typeof google.maps.geometry.spherical.computeDistanceBetween&&(n=google.maps.geometry.spherical.computeDistanceBetween(k.getAt(0),k.getAt(k.getLength()-1)),"function"===typeof a.polyline.getDistance&&a.polyline.getDistance.call(this,n)));b.setMap(c)}},drawPolygon:function(c,a){var b={},b="",d={},e=[];a=a?a:
this.options;if(f(a,"polygon")&&f(a.polygon,"coords")){for(b in a.polygon.coords)f(a.polygon.coords,b)&&(d=a.polygon.coords,m!==d[b]&&e.push(new google.maps.LatLng(d[b][0],d[b][1])));b=new google.maps.Polygon({path:e,strokeColor:a.polygon.color||"#FF0000",strokeOpacity:1,strokeWeight:a.polygon.width||2,fillColor:a.polygon.fillcolor||"#CC0000",fillOpacity:.35});this._polygons.push(b);b.setMap(this.map);"function"===typeof a.polygon.click&&google.maps.event.addListener(b,"click",a.polygon.click)}},
drawCircle:function(c,a){var b=0,d={lat:"",lng:""},e={},e={};a=a?a:this.options;if(f(a,"circle")&&l.isArray(a.circle))for(b=a.circle.length-1;0<=b;b-=1)e=a.circle[b],f(e,"center")&&(d=p(e.center)),d.lat&&d.lng&&(e=new google.maps.Circle({strokeColor:e.color||"#FF0000",strokeOpacity:e.opacity||.8,strokeWeight:e.width||2,fillColor:e.fillcolor||"#FF0000",fillOpacity:e.fillopacity||.35,map:this.map,center:new google.maps.LatLng(d.lat,d.lng),radius:e.radius||10,zIndex:100,id:f(a,"id")?a.id:""}),this._circles.push(e),
"function"===typeof a.circle[b].click&&google.maps.event.addListener(e,"click",a.circle[b].click))},overlay:function(){var c=this.map,a=this.options;try{this.kml(c,a),this.direction(c,a),this.markers(c,a),this.drawPolyline(c,a),this.drawPolygon(c,a),this.drawCircle(c,a),this.streetView(c,a),this.geoLocation(c,a)}catch(b){console.dir(b)}},markerIcon:function(c){var a={};if(f(c,"icon")){if("string"===typeof c.icon)return c.icon;f(c.icon,"url")&&(a.url=c.icon.url);f(c.icon,"size")&&m!==c.icon.size[0]&&
m!==c.icon.size[1]&&(a.scaledSize=new google.maps.Size(c.icon.size[0],c.icon.size[1]));f(c.icon,"anchor")&&m!==c.icon.anchor[0]&&m!==c.icon.anchor[1]&&(a.anchor=new google.maps.Point(c.icon.anchor[0],c.icon.anchor[1]))}return a},markerDirect:function(c,a){var b={},d={},d={},d=f(a,"id")?a.id:"",b=f(a,"title")?a.title.toString().replace(/<([^>]+)>/g,""):!1,e=f(a,"text")?a.text.toString():!1,g={map:c,position:a.addr,animation:null,id:d},h=this.markerIcon(a);b&&(g.title=b);e&&(g.text=e,g.infoWindow=new google.maps.InfoWindow({content:e}));
if("string"===typeof h||f(h,"url"))g.icon=h;f(a.animation)&&"string"===typeof a.animation&&(g.animation=google.maps.Animation[a.animation.toUpperCase()]);b=new google.maps.Marker(g);this._markers.push(b);f(b,"position")&&(b.getPosition().lat()&&b.getPosition().lng()&&this.bounds.extend(b.position),!0===this.options.markerFitBounds&&this._markers.length===this.options.marker.length&&c.fitBounds(this.bounds));!0===this.options.markerCluster&&"function"===typeof MarkerClusterer&&t===this.options.marker.length?
this.markerCluster=new MarkerClusterer(c,this._markers):(d={map:c,css:m!==a.css?a.css:"",id:d},"string"===typeof a.label&&0!==a.label.length&&(d.text=a.label,d=new n(d),d.bindTo("position",b,"position"),d.bindTo("text",b,"position"),d.bindTo("visible",b),this._labels.push(d)),this.bindEvents(b,a.event))},markerByGeocoder:function(c,a){var b=this;(new google.maps.Geocoder).geocode({address:a.addr},function(d,e){if(e===google.maps.GeocoderStatus.OVER_QUERY_LIMIT)q.setTimeout(function(){b.markerByGeocoder(c,
...
g=new google.maps.Marker(k);b._markers.push(g);f(g,"position")&&g.getPosition().lat()&&g.getPosition().lng()&&b.bounds.extend(k.position);!0===b.options.markerFitBounds&&b._markers.length===b.options.marker.length&&c.fitBounds(b.bounds);f(b.options,"markerCluster")&&"function"===typeof MarkerClusterer&&u===b.options.marker.length?b.markerCluster=new MarkerClusterer(c,b._markers):(h={map:b.map,css:a.css||""},"string"===typeof a.label&&0!==a.label.length&&(h.text=a.label,h=new n(h),h.bindTo("position",
g,"position"),h.bindTo("text",g,"position"),h.bindTo("visible",g),b._labels.push(h)),b.bindEvents(g,a.event))}})},directionService:function(c){var a=[],b=new google.maps.DirectionsService,d=new google.maps.DirectionsRenderer,e={travelMode:google.maps.DirectionsTravelMode.DRIVING,optimizeWaypoints:c.optimize||!1},g={},h=0,k=0;e.origin=p(c.from,!0);e.destination=p(c.to,!0);"string"===typeof c.travel&&c.travel.length&&(e.travelMode=google.maps.TravelMode[c.travel.toUpperCase()]);g=l(m!==c.panel?c.panel:
null);if(m!==c.waypoint&&0!==c.waypoint){h=0;for(k=c.waypoint.length;h<k;h+=1)a.push({location:p(c.waypoint[h],!0),stopover:!0});e.waypoints=a}m!==e.origin&&m!==e.destination&&(b.route(e,function(a,b){b===google.maps.DirectionsStatus.OK&&(f(c,"autoViewport")&&d.setOptions({preserveViewport:!1===c.autoViewport?!0:!1}),d.setDirections(a))}),d.setMap(this.map),g.length&&d.setPanel(g.get(0)),this._directions.push(d))},bindEvents:function(c,a){var b=this,d={};switch(typeof a){case "function":google.maps.event.addListener(c,
