/*! jQuery tinyMap v3.4.3, Licensed MIT (c) essoduke.org | https://code.essoduke.org/tinyMap/ */
...
Array.isArray(c.coords)){k=new google.maps.MVCArray;for(m=0;m<c.coords.length;m+=1)g=c.coords[m],g=t(g,!0),"function"===typeof g.lat&&k.push(g);g=h.extend({},{strokeColor:c.color||"#FF0000",strokeOpacity:c.opacity||1,strokeWeight:c.width||2},c);e=new google.maps.Polyline(g);this._polylines.push(e);if(2<k.getLength())for(m=0;m<k.length;m+=1)0<m&&k.length-1>m&&d.push({location:k.getAt(m),stopover:!1});c.hasOwnProperty("event")&&this.bindEvents(e,c.event);c.hasOwnProperty("snap")&&!0===c.snap?(g=new google.maps.DirectionsService,
