...
a.marker[e].addr[1])),f(a.marker[e],"text")&&(f(h[g],"infoWindow")?"function"===typeof h[g].infoWindow.setContent&&h[g].infoWindow.setContent(a.marker[e].text):(h[g].infoWindow=new google.maps.InfoWindow({content:a.marker[e].text}),this.bindEvents(h[g],a.marker[e].event))),f(a.marker[e],"icon")&&h[g].setIcon(a.marker[e].icon),f(a.marker[e],"title")&&(h[g].setTitle=a.marker[e].title));for(g=0;g<k.length;g+=1)a.marker[e].id===k[g].id&&(f(a.marker[e],"label")&&(k[g].text=a.marker[e].label),k[g].draw())}else l.isArray(a.marker[e].addr)?
this.markerDirect(c,a.marker[e]):"string"===typeof a.marker[e].addr&&this.markerByGeocoder(c,a.marker[e]);if(f(a,"markerCluster")&&!0===a.markerCluster&&"function"===typeof MarkerClusterer)return new MarkerClusterer(c,this._markers)},drawPolyline:function(c,a){var b={},d=0,e="",g={},h=0,k=new google.maps.MVCArray,l=[],g={},p=[],n={};a=a?a:this.options;if(f(a,"polyline")&&f(a.polyline,"coords")){for(e in a.polyline.coords)f(a.polyline.coords,e)&&(g=a.polyline.coords,m!==g[e]&&k.push(new google.maps.LatLng(g[e][0],
g[e][1])));b=new google.maps.Polyline({strokeColor:a.polyline.color||"#FF0000",strokeOpacity:1,strokeWeight:a.polyline.width||2});this._polylines.push(b);if(2<k.getLength())for(d=0;d<k.length;d+=1)0<d&&k.getLength()-1>d&&p.push({location:k[d],stopover:!1});!0===a.polyline.snap?(g=new google.maps.DirectionsService,g.route({origin:k.getAt(0),waypoints:p,destination:k.getAt(k.getLength()-1),travelMode:google.maps.DirectionsTravelMode.DRIVING},function(c,e){if(e===google.maps.DirectionsStatus.OK){d=0;
for(h=c.routes[0].overview_path.length;d<h;d+=1)l.push(c.routes[0].overview_path[d]);b.setPath(l);"function"===typeof a.polyline.getDistance&&(n=c.routes[0].legs[0].distance,a.polyline.getDistance.call(this,n))}})):(b.setPath(k),f(google.maps.geometry,"spherical")&&"function"===typeof google.maps.geometry.spherical.computeDistanceBetween&&(n=google.maps.geometry.spherical.computeDistanceBetween(k.getAt(0),k.getAt(k.getLength()-1)),"function"===typeof a.polyline.getDistance&&a.polyline.getDistance.call(this,
n)));b.setMap(c)}},drawPolygon:function(c,a){var b={},b="",d={},e=[];a=a?a:this.options;if(f(a,"polygon")&&f(a.polygon,"coords")){for(b in a.polygon.coords)f(a.polygon.coords,b)&&(d=a.polygon.coords,m!==d[b]&&e.push(new google.maps.LatLng(d[b][0],d[b][1])));b=new google.maps.Polygon({path:e,strokeColor:a.polygon.color||"#FF0000",strokeOpacity:1,strokeWeight:a.polygon.width||2,fillColor:a.polygon.fillcolor||"#CC0000",fillOpacity:.35});this._polygons.push(b);b.setMap(this.map);"function"===typeof a.polygon.click&&
...
"function"===typeof MarkerClusterer&&t===this.options.marker.length?this.markerCluster=new MarkerClusterer(c,this._markers):(d={map:c,css:m!==a.css?a.css:"",id:d},"string"===typeof a.label&&0!==a.label.length&&(d.text=a.label,d=new n(d),d.bindTo("position",b,"position"),d.bindTo("text",b,"position"),d.bindTo("visible",b),this._labels.push(d)),this.bindEvents(b,a.event))},markerByGeocoder:function(c,a){var b=this;(new google.maps.Geocoder).geocode({address:a.addr},function(d,e){if(e===google.maps.GeocoderStatus.OVER_QUERY_LIMIT)q.setTimeout(function(){b.markerByGeocoder(c,
