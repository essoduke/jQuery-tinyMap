...
d.hasOwnProperty("position")&&("function"===typeof d.getPosition&&this.bounds.extend(d.position),!0===this.options.markerFitBounds&&this._markers.length===this.options.marker.length&&b.fitBounds(this.bounds));if(!0===this.options.markerCluster&&"function"===typeof MarkerClusterer&&y===this.options.marker.length)return new MarkerClusterer(b,this._markers);a.hasOwnProperty("label")&&(c=new r({text:a.label,map:b,css:a.hasOwnProperty("css")?a.css.toString():"",id:c}),c.bindTo("position",d,"position"),
...
b.hasOwnProperty("to")){var a=this,d=new google.maps.DirectionsService,c=new google.maps.DirectionsRenderer,f={travelMode:google.maps.DirectionsTravelMode.DRIVING,optimizeWaypoints:b.hasOwnProperty("optimize")?b.optimize:!1},e={},h={},k=[],l={},n=[],u={},p="",g=0,s=0;f.origin=q(b.from,!0);f.destination=q(b.to,!0);b.hasOwnProperty("travel")&&google.maps.TravelMode[b.travel.toString().toUpperCase()]&&(f.travelMode=google.maps.TravelMode[b.travel.toString().toUpperCase()]);b.hasOwnProperty("panel")&&
(e=m(b.panel));if(b.hasOwnProperty("waypoint")&&Array.isArray(b.waypoint)){g=0;for(s=b.waypoint.length;g<s;g+=1)l={},"string"===typeof b.waypoint[g]||Array.isArray(b.waypoint[g])?l={location:q(b.waypoint[g],!0),stopover:!0}:(b.waypoint[g].hasOwnProperty("location")&&(l.location=q(b.waypoint[g].location,!0)),l.stopover=b.waypoint[g].hasOwnProperty("stopover")?b.waypoint[g].stopover:!0),n.push(b.waypoint[g].text||b.waypoint[g].toString()),k.push(l);f.waypoints=k}d.route(f,function(d,f){var e=0,g=0;
if(f===google.maps.DirectionsStatus.OK){e=d.routes[0].legs;b.hasOwnProperty("autoViewport")&&(h.preserveViewport=!1===b.autoViewport?!0:!1);try{for(b.hasOwnProperty("fromText")&&(e[0].start_address=b.fromText),b.hasOwnProperty("toText")&&(1===e.length?e[0].end_address=b.toText:e[e.length-1].end_address=b.toText),1===e.length?(u=e[0].end_location,p=e[0].end_address):(u=e[e.length-1].end_location,p=e[e.length-1].end_address),b.hasOwnProperty("icon")&&(h.suppressMarkers=!0,b.icon.hasOwnProperty("from")&&
"string"===typeof b.icon.from&&a.directionServiceMarker(e[0].start_location,{icon:b.icon.from,text:e[0].start_address}),b.icon.hasOwnProperty("to")&&"string"===typeof b.icon.to&&a.directionServiceMarker(u,{icon:b.icon.to,text:p})),g=0;g<e.length-1;g+=1)e[g].end_address=n[g],b.hasOwnProperty("icon")&&b.icon.hasOwnProperty("waypoint")&&a.directionServiceMarker(e[g].start_location,{icon:b.icon.waypoint,text:e[g].start_address})}catch(k){}a.bindEvents(c,b.event);c.setOptions(h);c.setDirections(d)}});
...
console.error(b)})):"function"===typeof c.panTo&&c.panTo(a))},clear:function(b){for(var a="marker,circle,polygon,polyline,direction,kml",d="",c=0,f=0,a="string"===typeof b?b.split(","):Array.isArray(b)?b:a.split(","),c=0;c<a.length;c+=1){d="_"+m.trim(a[c].toString().toLowerCase())+"s";if(t!==this[d]&&this[d].length){for(f=0;f<this[d].length;f+=1)this.map===this[d][f].getMap()&&(this[d][f].set("visible",!1),this[d][f].set("directions",null),this[d][f].setMap(null));this[d].length=0}if("direction"===
