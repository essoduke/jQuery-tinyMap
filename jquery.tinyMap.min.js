...
"#FF0000",strokeOpacity:1,strokeWeight:a.polyline.width||2});2<g.getLength()&&g.forEach(function(a,b){0<b&&g.getLength()-1>b&&p.push({location:a,stopover:!1})});!0===a.polyline.snap?(k=new google.maps.DirectionsService,k.route({origin:g.getAt(0),waypoints:p,destination:g.getAt(g.getLength()-1),travelMode:google.maps.DirectionsTravelMode.DRIVING},function(b,e){if(e===google.maps.DirectionsStatus.OK){c=0;for(l=b.routes[0].overview_path.length;c<l;c+=1)m.push(b.routes[0].overview_path[c]);d.setPath(m);
"function"===typeof a.polyline.getDistance&&(n=b.routes[0].legs[0].distance,a.polyline.getDistance.call(this,n))}})):(d.setPath(g),"function"===typeof google.maps.geometry.spherical.computeDistanceBetween&&(n=google.maps.geometry.spherical.computeDistanceBetween(g.getAt(0),g.getAt(g.getLength()-1)),"function"===typeof a.polyline.getDistance&&a.polyline.getDistance.call(this,n)));d.setMap(b)}},drawPolygon:function(b,a){var d={},d="",c={},e=[];a=a?a:this.options;if(h!==a.polygon&&h!==a.polygon.coords){for(d in a.polygon.coords)f(a.polygon.coords,
d)&&(c=a.polygon.coords,h!==c[d]&&e.push(new google.maps.LatLng(c[d][0],c[d][1])));d=new google.maps.Polygon({path:e,strokeColor:a.polygon.color||"#FF0000",strokeOpacity:1,strokeWeight:a.polygon.width||2,fillColor:a.polygon.fillcolor||"#CC0000",fillOpacity:.35});this._polygons.push(d);d.setMap(this.map);m.isFunction(a.polygon.click)&&google.maps.event.addListener(d,"click",a.polygon.click)}},drawCircle:function(b,a){var d=0,c={},c={};a=a?a:this.options;if(h!==a.circle&&0<a.circle.length)for(d=a.circle.length-
1;0<=d;d-=1)c=a.circle[d],h!==c.center.x&&h!==c.center.y&&(c=new google.maps.Circle({strokeColor:c.color||"#FF0000",strokeOpacity:c.opacity||.8,strokeWeight:c.width||2,fillColor:c.fillcolor||"#FF0000",fillOpacity:c.fillopacity||.35,map:this.map,center:new google.maps.LatLng(c.center.x,c.center.y),radius:c.radius||10,zIndex:100,id:f(a,"id")?a.id:""}),this._circles.push(c),m.isFunction(a.circle[d].click)&&google.maps.event.addListener(c,"click",a.circle[d].click))},overlay:function(){var b=this.map,
a=this.options;this.kml(b,a);this.direction(b,a);this.markers(b,a);this.drawPolyline(b,a);this.drawPolygon(b,a);this.drawCircle(b,a);this.streetView(b,a)},markerIcon:function(b){var a={};if(f(b,"icon")){if("string"===typeof b.icon)return b.icon;f(b.icon,"url")&&(a.url=b.icon.url);f(b.icon,"size")&&h!==b.icon.size[0]&&h!==b.icon.size[1]&&(a.scaledSize=new google.maps.Size(b.icon.size[0],b.icon.size[1]));f(b.icon,"anchor")&&h!==b.icon.anchor[0]&&h!==b.icon.anchor[1]&&(a.anchor=new google.maps.Point(b.icon.anchor[0],
b.icon.anchor[1]))}return a},markerDirect:function(b,a){var d={},c={},c={},c=f(a,"id")?a.id:"",d=f(a,"title")?a.title.toString().replace(/<([^>]+)>/g,""):"",e=f(a,"text")?a.text.toString():"",e={map:b,position:new google.maps.LatLng(a.addr[0],a.addr[1]),infoWindow:new google.maps.InfoWindow({content:e}),animation:null,id:c},k=this.markerIcon(a);d&&(e.title=d);n+=1;if("string"===typeof k||f(k,"url"))e.icon=k;f(a.animation)&&"string"===typeof a.animation&&(e.animation=google.maps.Animation[a.animation.toUpperCase()]);
d=new google.maps.Marker(e);this._markers.push(d);if(f(d,"position")&&(d.getPosition().lat()&&d.getPosition().lng()&&this.bounds.extend(e.position),!0===this.options.markerFitBounds&&n===this.options.marker.length))return b.fitBounds(this.bounds);!0===this.options.markerCluster&&"function"===typeof MarkerClusterer&&n===this.options.marker.length?this.markerCluster=new MarkerClusterer(b,this._markers):(c={map:b,css:h!==a.css?a.css:"",id:c},"string"===typeof a.label&&0!==a.label.length&&(c.text=a.label,
c=new p(c),c.bindTo("position",d,"position"),c.bindTo("text",d,"position"),c.bindTo("visible",d),this._labels.push(c)),this.bindEvents(d,a.event))},markerByGeocoder:function(b,a){var d=new google.maps.Geocoder,c=this;-1!==a.addr.indexOf(",")&&(a.addr="loc: "+a.addr);d.geocode({address:a.addr},function(d,k){if(k===google.maps.GeocoderStatus.OVER_QUERY_LIMIT)r.setTimeout(function(){c.markerByGeocoder(a)},c.interval);else if(k===google.maps.GeocoderStatus.OK){var l={},g={},g={},l=f(a,"title")?a.title.toString().replace(/<([^>]+)>/g,
""):"",g=f(a,"text")?a.text.toString():"",g={map:b,position:d[0].geometry.location,title:l,infoWindow:new google.maps.InfoWindow({content:g}),animation:null},h=c.markerIcon(a);l&&(g.title=l);q+=1;if("string"===typeof h||f(h,"url"))g.icon=h;f(a,"animation")&&"string"===typeof a.animation&&(g.animation=google.maps.Animation[a.animation.toUpperCase()]);l=new google.maps.Marker(g);c._markers.push(l);f(l,"position")&&l.getPosition().lat()&&l.getPosition().lng()&&c.bounds.extend(g.position);if(!0===c.options.markerFitBounds&&
...
c=new google.maps.DirectionsRenderer,e={travelMode:google.maps.DirectionsTravelMode.DRIVING,optimizeWaypoints:b.optimize||!1},k={},f=0,g=0;"string"===typeof b.from&&(e.origin=b.from);"string"===typeof b.to&&(e.destination=b.to);"string"===typeof b.travel&&b.travel.length&&(e.travelMode=google.maps.TravelMode[b.travel.toUpperCase()]);k=m(h!==b.panel?b.panel:null);if(h!==b.waypoint&&0!==b.waypoint){f=0;for(g=b.waypoint.length;f<g;f+=1)a.push({location:b.waypoint[f].toString(),stopover:!0});e.waypoints=
a}h!==e.origin&&h!==e.destination&&(d.route(e,function(a,b){b===google.maps.DirectionsStatus.OK&&c.setDirections(a)}),c.setMap(this.map),k.length&&c.setPanel(k.get(0)),this._directions.push(c))},bindEvents:function(b,a){var d=this,c={};switch(typeof a){case "function":google.maps.event.addListener(b,"click",a);break;case "object":for(c in a)"function"===typeof a[c]?google.maps.event.addListener(b,c,a[c]):f(a[c],"func")&&"function"===typeof a[c].func?f(a[c],"once")&&!0===a[c].once?google.maps.event.addListenerOnce(b,
c,a[c].func):google.maps.event.addListener(b,c,a[c].func):"function"===typeof a[c]&&google.maps.event.addListener(b,c,a[c])}f(b,"infoWindow")&&google.maps.event.addListener(b,"click",function(){b.infoWindow.open(d.map,b)})},streetView:function(b,a){var d=b.getStreetView();d.setPosition(b.getCenter());f(a,"showStreetView")&&d.setVisible(a.showStreetView)},init:function(){var b=this,a={};"string"===typeof b.options.center?r.setTimeout(function(){var d=m(b.container),c="";-1!==b.options.center.indexOf(",")&&
...
function(a,b){b===google.maps.GeocoderStatus.OK&&m.isFunction(c.panTo)&&h!==a[0]&&c.panTo(a[0].geometry.location)})):("[object Array]"===Object.prototype.toString.call(b)?2===b.length&&(a=new google.maps.LatLng(b[0],b[1])):f(b,"lat")&&f(b,"lng")?a=new google.maps.LatLng(b.lat,b.lng):f(b,"x")&&f(b,"y")&&(a=new google.maps.LatLng(b.x,b.y)),m.isFunction(c.panTo)&&h!==a&&c.panTo(a)))},clear:function(b){for(var a=[],d="",c=0,e=0,a="string"===typeof b?b.split(","):"[object Array]"===Object.prototype.toString.call(b)?
b:[],c=0;c<a.length;c+=1)if(d="_"+m.trim(a[c].toString().toLowerCase())+"s",h!==this[d]&&this[d].length){for(e=0;e<this[d].length;e+=1)this.map===this[d][e].getMap()&&(this[d][e].set("visible",!1),this[d][e].set("directions",null),this[d][e].setMap(null));this[d].length=0}},modify:function(b){var a=[],d=[["kml","kml"],["marker","markers"],["direction","direction"],["polyline","drawPolyline"],["polygon","drawPolygon"],["circle","drawCircle"],["zoom","setZoom"],["showStreetView","streetView"]],c=0,
e=this.map;if(h!==b){for(c=0;c<d.length;c+=1)f(b,d[c][0])&&a.push(d[c][1]);if(null!==e)if(a.length)for(c=0;c<a.length;c+=1){if("function"===typeof this[a[c]])this[a[c]](e,b,"modify")}else e.setOptions(b)}}};m.fn.tinyMap=function(b){var a=arguments,d=[],c={};return"string"===typeof b?(this.each(function(){c=m.data(this,"tinyMap");c instanceof s&&"function"===typeof c[b]&&(d=c[b].apply(c,Array.prototype.slice.call(a,1)))}),h!==d?d:this):this.each(function(){m.data(this,"tinyMap")||m.data(this,"tinyMap",
new s(this,b))})}})(jQuery,window,document);
