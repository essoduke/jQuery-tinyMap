...
style:"DEFAULT"},scrollwheel:!0,streetViewControl:!0,streetViewControlOptions:{position:"LEFT_TOP"},zoom:4,zoomControl:!0,zoomControlOptions:{style:"LARGE",position:"LEFT_TOP"},notfound:"\u627e\u4e0d\u5230\u67e5\u8a62\u7684\u5730\u9ede",loading:"\u8b80\u53d6\u4e2d&hellip;",kml:{url:"",viewport:!0,infowindow:!1},interval:200};l.prototype=new google.maps.OverlayView;l.prototype.onAdd=function(){var a=this.getPanes().overlayLayer;this.div.appendTo(h(a));this.listeners=[google.maps.event.addListener(this,
...
"#FF0000",strokeOpacity:1,strokeWeight:b.polyline.width||2});this._polylines.push(c);c.setMap(a)}},drawPolygon:function(a,b){var c={},c="",d={},k=[];b=b?b:this.options;if(e!==b.polygon&&e!==b.polygon.coords){for(c in b.polygon.coords)f(b.polygon.coords,c)&&(d=b.polygon.coords,e!==d[c]&&k.push(new google.maps.LatLng(d[c][0],d[c][1])));c=new google.maps.Polygon({path:k,strokeColor:b.polygon.color||"#FF0000",strokeOpacity:1,strokeWeight:b.polygon.width||2,fillColor:b.polygon.fillcolor||"#CC0000",fillOpacity:0.35});
