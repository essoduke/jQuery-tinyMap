...
style:"DEFAULT"},scaleControl:!0,scaleControlOptions:{position:"BOTTOM_LEFT",style:"DEFAULT"},scrollwheel:!0,streetViewControl:!0,streetViewControlOptions:{position:"LEFT_TOP"},zoom:4,zoomControl:!0,zoomControlOptions:{style:"LARGE",position:"LEFT_TOP"},notfound:"\u627e\u4e0d\u5230\u67e5\u8a62\u7684\u5730\u9ede",loading:"\u8b80\u53d6\u4e2d&hellip;",kml:{url:"",viewport:!0,infowindow:!1},interval:200,event:null,showStreetView:!1,autoLocation:!1},n=0,q=0;p.prototype=new google.maps.OverlayView;p.prototype.onAdd=
function(){var b=this.getPanes().overlayLayer;this.div.appendTo(m(b));this.listeners=[google.maps.event.addListener(this,"visible_changed",this.onRemove)]};p.prototype.draw=function(){var b=this.getProjection(),a={};try{a=b.fromLatLngToDivPixel(this.get("position")),this.div.css({left:a.x+"px",top:a.y+"px",display:"block"}),this.text&&this.span.html(this.text.toString())}catch(d){}};p.prototype.onRemove=function(){m(this.div).remove()};s.prototype={VERSION:"2.8.3",_polylines:[],_polygons:[],_circles:[],
_kmls:[],_directions:[],bounds:new google.maps.LatLngBounds,setZoom:function(b,a){f(a,"zoom")&&b&&b.setZoom(a.zoom)},kml:function(b,a){var d={},c="",d={};a=a?a:this.options;g!==a.kml&&(d={preserveViewport:!0,suppressInfoWindows:!1},c="string"===typeof a.kml&&0!==a.kml.length?a.kml:g!==a.kml.url?a.kml.url:"",d=new google.maps.KmlLayer(c,m.extend(d,a.kml)),this._kmls.push(d),d.setMap(b))},direction:function(b,a){var d="";a=a?a:this.options;if(g!==a.direction&&0<a.direction.length)for(d in a.direction)f(a.direction,
d)&&g!==a.direction[d]&&this.directionService(a.direction[d])},markers:function(b,a,d){var c="",e=0,k=0,l=[],h=[];a=a?a:this.options;q=n=0;l=this._markers;if((!d||0===l.length)&&g!==a.marker&&0<a.marker.length)for(c in a.marker)f(a.marker,c)&&f(a.marker[c],"addr")&&("object"===typeof a.marker[c].addr&&2===a.marker[c].addr.length?this.markerDirect(b,a.marker[c],a):"string"===typeof a.marker[c].addr&&this.markerByGeocoder(b,a.marker[c],a));if("modify"===d)for(h=this._labels,e=0;e<a.marker.length;e+=
1)if(g!==a.marker[e].id){for(k=0;k<l.length;k+=1)a.marker[e].id===l[k].id&&g!==a.marker[e].addr&&(l[k].setPosition(new google.maps.LatLng(a.marker[e].addr[0],a.marker[e].addr[1])),"function"===typeof l[e].infoWindow.setContent&&l[k].infoWindow.setContent(a.marker[e].text));for(k=0;k<h.length;k+=1)a.marker[e].id===h[k].id&&(f(a.marker[e],"label")&&(h[k].text=a.marker[e].label),h[k].draw())}else"object"===typeof a.marker[e].addr&&2===a.marker[e].addr.length?this.markerDirect(b,a.marker[e]):"string"===
typeof a.marker[e].addr&&this.markerByGeocoder(b,a.marker[e]);if(f(a,"markerCluster")&&!0===a.markerCluster&&"function"===typeof MarkerClusterer)return new MarkerClusterer(b,this._markers)},drawPolyline:function(b,a){var d={},c=0,e="",k={},l=0,h=new google.maps.MVCArray,m=[],k={},p=[],n={};a=a?a:this.options;if(g!==a.polyline&&g!==a.polyline.coords){for(e in a.polyline.coords)f(a.polyline.coords,e)&&(k=a.polyline.coords,g!==k[e]&&h.push(new google.maps.LatLng(k[e][0],k[e][1])));d=new google.maps.Polyline({strokeColor:a.polyline.color||
...
b.icon.size[1]));f(b.icon,"anchor")&&g!==b.icon.anchor[0]&&g!==b.icon.anchor[1]&&(a.anchor=new google.maps.Point(b.icon.anchor[0],b.icon.anchor[1]))}return a},markerDirect:function(b,a){var d={},c={},c={},c=f(a,"id")?a.id:"",d=f(a,"title")?a.title.toString().replace(/<([^>]+)>/g,""):"",e=f(a,"text")?a.text.toString():"",e={map:b,position:new google.maps.LatLng(a.addr[0],a.addr[1]),infoWindow:new google.maps.InfoWindow({content:e}),animation:null,id:c},k=this.markerIcon(a);d&&(e.title=d);n+=1;if("string"===
typeof k||f(k,"url"))e.icon=k;f(a.animation)&&"string"===typeof a.animation&&(e.animation=google.maps.Animation[a.animation.toUpperCase()]);d=new google.maps.Marker(e);this._markers.push(d);if(f(d,"position")&&(d.getPosition().lat()&&d.getPosition().lng()&&this.bounds.extend(e.position),!0===this.options.markerFitBounds&&n===this.options.marker.length))return b.fitBounds(this.bounds);!0===this.options.markerCluster&&"function"===typeof MarkerClusterer&&n===this.options.marker.length?this.markerCluster=
...
c.interval);else if(k===google.maps.GeocoderStatus.OK){var l={},h={},h={},h=f(a,"id")?a.id:"",l=f(a,"title")?a.title.toString().replace(/<([^>]+)>/g,""):"",g=f(a,"text")?a.text.toString():"",h={map:b,position:d[0].geometry.location,title:l,infoWindow:new google.maps.InfoWindow({content:g}),animation:null,id:h},g=c.markerIcon(a);l&&(h.title=l);q+=1;if("string"===typeof g||f(g,"url"))h.icon=g;f(a,"animation")&&"string"===typeof a.animation&&(h.animation=google.maps.Animation[a.animation.toUpperCase()]);
l=new google.maps.Marker(h);c._markers.push(l);f(l,"position")&&l.getPosition().lat()&&l.getPosition().lng()&&c.bounds.extend(h.position);if(!0===c.options.markerFitBounds&&q===c.options.marker.length)return b.fitBounds(c.bounds);f(c.options,"markerCluster")&&"function"===typeof MarkerClusterer&&q===c.options.marker.length?c.markerCluster=new MarkerClusterer(b,c._markers):(h={map:c.map,css:a.css||""},"string"===typeof a.label&&0!==a.label.length&&(h.text=a.label,h=new p(h),h.bindTo("position",l,"position"),
h.bindTo("text",l,"position"),h.bindTo("visible",l),c._labels.push(h)),c.bindEvents(l,a.event))}})},directionService:function(b){var a=[],d=new google.maps.DirectionsService,c=new google.maps.DirectionsRenderer,e={travelMode:google.maps.DirectionsTravelMode.DRIVING,optimizeWaypoints:b.optimize||!1},k={},f=0,h=0;"string"===typeof b.from&&(e.origin=b.from);"string"===typeof b.to&&(e.destination=b.to);"string"===typeof b.travel&&b.travel.length&&(e.travelMode=google.maps.TravelMode[b.travel.toUpperCase()]);
k=m(g!==b.panel?b.panel:null);if(g!==b.waypoint&&0!==b.waypoint){f=0;for(h=b.waypoint.length;f<h;f+=1)a.push({location:b.waypoint[f].toString(),stopover:!0});e.waypoints=a}g!==e.origin&&g!==e.destination&&(d.route(e,function(a,b){b===google.maps.DirectionsStatus.OK&&c.setDirections(a)}),c.setMap(this.map),k.length&&c.setPanel(k.get(0)),this._directions.push(c))},bindEvents:function(b,a){var d=this,c={};switch(typeof a){case "function":google.maps.event.addListener(b,"click",a);break;case "object":for(c in a)"function"===
