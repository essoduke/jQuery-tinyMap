...
this,e={},g={maxZoom:null,gridSize:60},h=Array.isArray(c.marker)?c.marker:[];d.options.hasOwnProperty("markerCluster")&&"function"===typeof MarkerClusterer&&(g=f.extend({},g,c.markerCluster),d._clusters=new MarkerClusterer(a,[],g),g.hasOwnProperty("event")&&d.bindEvents(d._clusters,g.event));h.forEach(function(g){var h=p(g.addr,!0),q=d.markerIcon(g),k={map:a,animation:null},u=!0,n=!1,v={},w={},F="undefined"!==typeof g.id?g.id:!1,k=f.extend({},k,g);"modify"===b&&F&&d.get({marker:[F]},function(a){!a.marker||
g.hasOwnProperty("forceInsert")&&!0===g.forceInsert||(g=f.extend(a.marker[0],g),"function"===typeof d._clusters.removeMarker&&d._clusters.removeMarker(a.marker[0]),u=!1,n=!0)});g.hasOwnProperty("title")&&(k.title=g.title.toString().replace(/<([^>]+)>/g,""));f.isEmptyObject(q)||(k.icon=q);g.hasOwnProperty("animation")&&"string"===typeof g.animation&&(k.animation=google.maps.Animation[g.animation.toUpperCase()]);"string"===typeof h?(e=new google.maps.Geocoder,e.geocode({address:h},function(e,h){h===
google.maps.GeocoderStatus.OVER_QUERY_LIMIT?setTimeout(function(){d.placeMarkers(a,c,b)},d.interval):h===google.maps.GeocoderStatus.OK&&(!u&&n?("function"===typeof g.setPosition&&g.setPosition(e[0].geometry.location),w=g):(k.position=e[0].geometry.location,v=c.hasOwnProperty("markerWithLabel")&&!0===c.markerWithLabel?"function"===typeof MarkerWithLabel?new MarkerWithLabel(k):new google.maps.Marker(k):new google.maps.Marker(k),d._markers.push(v),w=v),d.processMarker(a,c,w,b))})):(!u&&n?("function"===
typeof g.setPosition&&g.setPosition(h),w=g):(k.position=h,v=c.hasOwnProperty("markerWithLabel")&&!0===c.markerWithLabel?"function"===typeof MarkerWithLabel?new MarkerWithLabel(k):new google.maps.Marker(k):new google.maps.Marker(k),d._markers.push(v),w=v),d.processMarker(a,c,w,b))})},direction:function(a,c){var b=0;if(c.hasOwnProperty("direction")&&Array.isArray(c.direction))for(b=0;b<c.direction.length;b+=1)"undefined"!==typeof c.direction[b]&&this.directionService(c.direction[b])},directionService:function(a){if(!a.hasOwnProperty("from")||
!a.hasOwnProperty("to"))return!1;var c=this,b=new google.maps.DirectionsService,d=new google.maps.DirectionsRenderer,e={},g=[],h=[],l=new google.maps.InfoWindow,m=[],q={},k="",u="",n={travelMode:google.maps.DirectionsTravelMode.DRIVING,optimizeWaypoints:a.hasOwnProperty("optimize")?a.optimize:!0};i=0;n.origin=p(a.from,!0);n.destination=p(a.to,!0);q=f.extend({},{infoWindow:l,map:c.map},a);a.hasOwnProperty("travel")&&google.maps.TravelMode[a.travel.toString().toUpperCase()]&&(n.travelMode=google.maps.TravelMode[a.travel.toString().toUpperCase()]);
...
h.push(a.waypoint[i].icon.toString()),m.push(e);n.waypoints=m}b.route(n,function(b,e){var f=[],m={},n=0;if(e===google.maps.DirectionsStatus.OK){f=b.routes[0].legs;try{a.hasOwnProperty("fromText")&&(k=f[0].start_address=a.fromText);a.hasOwnProperty("toText")&&(1===f.length?f[0].end_address=a.toText:f[f.length-1].end_address=a.toText,u=a.toText);a.hasOwnProperty("icon")&&(q.suppressMarkers=!0,a.icon.hasOwnProperty("from")&&"string"===typeof a.icon.from&&c.directionServiceMarker(f[0].start_location,
{icon:a.icon.from,text:k},l,a),a.icon.hasOwnProperty("to")&&"string"===typeof a.icon.to&&c.directionServiceMarker(f[f.length-1].end_location,{icon:a.icon.to,text:u},l,a));for(n=1;n<f.length;n+=1)a.hasOwnProperty("icon")&&(a.icon.hasOwnProperty("waypoint")&&"string"===typeof a.icon.waypoint?m.icon=a.icon.waypoint:"string"===typeof h[n-1]&&(m.icon=h[n-1]),m.text=g[n-1],c.directionServiceMarker(f[n].start_location,m,l,a));a.hasOwnProperty("event")&&a.event.hasOwnProperty("created")&&"function"===typeof a.event.created&&
...
"").replace(/#PLACEMARKS#/gi,e+g+h+l+m);if(!0===c.download)x.open("data:application/vnd.google-earth.kml+xml;charset=utf-8;base64,"+x.btoa(decodeURIComponent(encodeURIComponent(a))));else return a},init:function(){var a=this,c={},c={},b=f.extend({},t),d=b.api.split("?")[0],e="",g={};try{delete b.api,delete b.clusterer,delete b.withLabel,b=f.param(b)}catch(h){}C||"undefined"!==typeof x.google||(c=r.createElement("script"),c.setAttribute("src",[d,b].join("?")),(r.getElementsByTagName("head")[0]||r.documentElement).appendChild(c),
C=!0,c=null);if("object"===typeof x.google){!D&&a.options.hasOwnProperty("markerCluster")&&!1!==a.options.markerCluster&&"undefined"===typeof MarkerClusterer&&(c=r.createElement("script"),c.setAttribute("src",t.clusterer),(r.getElementsByTagName("head")[0]||r.documentElement).appendChild(c),D=!0,c=null);!E&&a.options.hasOwnProperty("markerWithLabel")&&!0===a.options.markerWithLabel&&"undefined"===typeof MarkerWithLabel&&(c=r.createElement("script"),c.setAttribute("src",t.withLabel),(r.getElementsByTagName("head")[0]||
...
"idle",function(){a.overlay();google.maps.event.trigger(a.map,"resize")}),a.bindEvents(a.map,a.options.event))}}};f.fn.tinyMapConfigure=function(a){t=f.extend(t,a)};f.fn.tinyMapDistance=function(a,c){var b={key:t.hasOwnProperty("key")?t.key:"",origins:[],destinations:[],language:"zh-TW"},b=f.extend({},b,a);Array.isArray(b.origins)&&(b.origins=b.origins.join("|"));Array.isArray(b.destinations)&&(b.destinations=b.destinations.join("|"));f.getJSON("//maps.googleapis.com/maps/api/distancematrix/json",
b,function(a){"OK"===a.status&&c.cal(this,a)})};f.fn.tinyMapQuery=function(a,c){var b={key:t.hasOwnProperty("key")?t.key:"",language:"zh-TW"},d=f.extend({},b,a),e=null;f.getJSON("//maps.googleapis.com/maps/api/geocode/json",d,function(a){"OK"===a.status&&a.results&&"undefined"!==typeof a.results[0]&&(d.hasOwnProperty("latlng")?e=a.results[0].formatted_address:d.hasOwnProperty("address")&&(e=[a.results[0].geometry.location.lat,a.results[0].geometry.location.lng].join()),c.call(this,e))})};f.fn.tinyMap=
