(function(h,n,s,f){function e(a,b){try{return n.hasOwnProperty?a.hasOwnProperty(b.toString()):Object.prototype.hasOwnProperty.call(a,b.toString())}catch(c){}}function m(a){var b=a.css||"";this.setValues(a);this.span=h("<span/>").css({position:"relative",left:"-50%",top:"0","white-space":"nowrap"}).addClass(b);this.div=h("<div/>").css({position:"absolute",display:"none"});this.span.appendTo(this.div)}function p(a,b){e(n,"google")&&(this.map=null,this.container=a,this.options=h.extend({},r,b),this.interval=
...
this.options;if(f!==b.polyline&&f!==b.polyline.coords){for(c in b.polyline.coords)e(b.polyline.coords,c)&&(d=b.polyline.coords,f!==d[c]&&k.push(new google.maps.LatLng(d[c][0],d[c][1])));c=new google.maps.Polyline({path:k,strokeColor:b.polyline.color||"#FF0000",strokeOpacity:1,strokeWeight:b.polyline.width||2});this._polylines.push(c);c.setMap(a)}},drawPolygon:function(a,b){var c={},c="",d={},k=[];b=b?b:this.options;if(f!==b.polygon&&f!==b.polygon.coords){for(c in b.polygon.coords)e(b.polygon.coords,
c)&&(d=b.polygon.coords,f!==d[c]&&k.push(new google.maps.LatLng(d[c][0],d[c][1])));c=new google.maps.Polygon({path:k,strokeColor:b.polygon.color||"#FF0000",strokeOpacity:1,strokeWeight:b.polygon.width||2,fillColor:b.polygon.fillcolor||"#CC0000",fillOpacity:0.35});this._polygons.push(c);c.setMap(this.map);h.isFunction(b.polygon.click)&&google.maps.event.addListener(c,"click",b.polygon.click)}},drawCircle:function(a,b){var c=0,d={},d={};b=b?b:this.options;if(f!==b.circle&&0<b.circle.length)for(c=b.circle.length-
...
function(b,k){if(k===google.maps.GeocoderStatus.OVER_QUERY_LIMIT)n.setTimeout(function(){c.markerByGeocoder(a)},c.interval);else if(k===google.maps.GeocoderStatus.OK){var g={},l={},l={},g={},g=e(a,"text")?a.text.toString():"",l={map:c.map,position:b[0].geometry.location,title:g,infoWindow:new google.maps.InfoWindow({content:g}),animation:null};if(g=c.markerIcon(a))l.icon=g;e(a,"animation")&&"string"===typeof a.animation&&(l.animation=google.maps.Animation[a.animation.toUpperCase()]);g=new google.maps.Marker(l);
c._markers.push(g);f!==a.cluster&&(f===c._cluster[a.cluster]&&(c._cluster[a.cluster]=[]),c._cluster[a.cluster].push(g));e(g,"position")&&g.getPosition().lat()&&g.getPosition().lng()&&c.bounds.extend(l.position);l={map:c.map,css:a.css||""};"string"===typeof a.label&&0!==a.label.length&&(l.text=a.label);l=new m(l);l.bindTo("position",g,"position");l.bindTo("text",g,"position");l.bindTo("visible",g);c.bindEvent(g,a.event)}})},directionService:function(a){var b=[],c=new google.maps.DirectionsService,
d=new google.maps.DirectionsRenderer,k={travelMode:google.maps.DirectionsTravelMode.DRIVING,optimizeWaypoints:a.optimize||!1},g=0,e=0;"string"===typeof a.from&&(k.origin=a.from);"string"===typeof a.to&&(k.destination=a.to);"string"===typeof a.travel&&0<a.travel.length&&(k.travelMode=google.maps.DirectionsTravelMode[a.travel.toUpperCase()]);if(f!==a.waypoint&&0!==a.waypoint){g=0;for(e=a.waypoint.length;g<e;g+=1)b.push({location:a.waypoint[g].toString(),stopover:!0});k.waypoints=b}f!==k.origin&&f!==
k.destination&&(c.route(k,function(a,b){b===google.maps.DirectionsStatus.OK&&d.setDirections(a)}),d.setMap(this.map),this._directions.push(d))},bindEvent:function(a,b){var c=this;"function"===typeof b?google.maps.event.addListener(a,"click",b):e(b,"type")?"string"===typeof b.type&&"function"===typeof b.bind&&google.maps.event.addListener(a,b.type,b.bind):google.maps.event.addListener(a,"click",function(){a.infoWindow.open(c.map,a)})},init:function(){var a=this,b={},c={};q+=1;"string"===typeof this.options.center?
n.setTimeout(function(){var d=h(a.container),k="";-1!==a.options.center.indexOf(",")&&(a.options.center="loc: "+a.options.center);c=new google.maps.Geocoder;c.geocode({address:a.options.center},function(c,l){try{l===google.maps.GeocoderStatus.OVER_QUERY_LIMIT?a.init():l===google.maps.GeocoderStatus.OK&&0!==c.length?(a.GoogleMapOptions.center=l===google.maps.GeocoderStatus.OK&&0!==c.length?c[0].geometry.location:"",a.map=new google.maps.Map(a.container,a.GoogleMapOptions),google.maps.event.addListenerOnce(a.map,
"idle",function(){a.overlay();a.options.marker.length&&!0===a.options.markerFitBounds&&setTimeout(function(){a.map.fitBounds(a.bounds)},a.interval);if("function"===typeof MarkerClusterer)for(b in a._cluster)e(a._cluster,b)&&new MarkerClusterer(a.map,a._cluster[b])})):(k=a.options.notfound.text||l,d.html(k.replace(/</g,"&lt;").replace(/>/g,"&gt;")))}catch(h){d.html((f!==h.message?h.message:h.description).toString())}})},a.interval*q):(a.map=new google.maps.Map(a.container,a.GoogleMapOptions),google.maps.event.addListenerOnce(a.map,
"idle",function(){a.overlay();a.options.marker.length&&!0===a.options.markerFitBounds&&a.map.fitBounds(a.bounds);if("function"===typeof MarkerClusterer)for(b in a._cluster)e(a._cluster,b)&&new MarkerClusterer(a.map,a._cluster[b])}))},panto:function(a){var b=this,c="",d={};e(b,"map")&&null!==b.map&&f!==b.map&&("string"===typeof a?(-1!==a.indexOf(",")&&(c="loc: "+a),d=new google.maps.Geocoder,d.geocode({address:a},function(a,c){c===google.maps.GeocoderStatus.OK&&h.isFunction(b.map.panTo)&&f!==a[0]&&
b.map.panTo(a[0].geometry.location)})):("[object Array]"===Object.prototype.toString.call(a)?2===a.length&&(c=new google.maps.LatLng(a[0],a[1])):e(a,"lat")&&e(a,"lng")?c=new google.maps.LatLng(a.lat,a.lng):e(a,"x")&&e(a,"y")&&(c=new google.maps.LatLng(a.x,a.y)),h.isFunction(b.map.panTo)&&f!==c&&b.map.panTo(c)))},clear:function(a){var b=[],c="",d=0,e=0;"string"===typeof a&&(b=a.split(","));for(d=0;d<b.length;d+=1)if(c="_"+h.trim(b[d].toString().toLowerCase())+"s",f!==this[c]&&this[c].length){for(e=
0;e<this[c].length;e+=1)this.map===this[c][e].getMap()&&(this[c][e].set("visible",!1),this[c][e].setMap(this.map,null),this[c][e].set("directions",null));this[c]=[]}},modify:function(a){var b=[],c=[["kml","kml"],["marker","markers"],["direction","direction"],["polyline","drawPolyline"],["polygon","drawPolygon"],["circle","drawCircle"],["zoom","setZoom"]],d=0;if(f!==a){for(d=0;d<c.length;d+=1)e(a,c[d][0])&&b.push(c[d][1]);if(null!==this.map&&f!==this.map&&b)for(d=0;d<b.length;d+=1)if("function"===
typeof this[b[d]])this[b[d]](this.map,a)}}};h.fn.tinyMap=function(a){var b=arguments,c=[],d={};return"string"===typeof a?(this.each(function(){d=h.data(this,"tinyMap");d instanceof p&&"function"===typeof d[a]&&(c=d[a].apply(d,Array.prototype.slice.call(b,1)))}),f!==c?c:this):this.each(function(){h.data(this,"tinyMap")||h.data(this,"tinyMap",new p(this,a))})}})(jQuery,window,document);
