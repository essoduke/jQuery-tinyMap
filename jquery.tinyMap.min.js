...
C={autoLocation:!1,center:[24,121],infoWindowAutoClose:!0,interval:200,loading:"\u8b80\u53d6\u4e2d&hellip;",notFound:"\u627e\u4e0d\u5230\u67e5\u8a62\u7684\u5730\u9ede",zoom:8},y={},y={greyscale:[{featureType:"all",stylers:[{saturation:-100},{gamma:.5}]}]};x.prototype={VERSION:"3.2.19",formatSize:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Size(a[0],a[1]):a},formatPoint:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Point(a[0],a[1]):a},overlay:function(){var a=
...
drawPolyline:function(a,b){var c={},d=[],e={},f={},g={},g={},k=[],m=[],p=0,g={},g={},l=0,D=function(a,b){if(b===google.maps.DirectionsStatus.OK){for(l=0;l<a.routes[0].overview_path.length;l+=1)m.push(a.routes[0].overview_path[l]);e.setPath(m);"function"===typeof c.getDistance&&(f=a.routes[0].legs[0].distance,c.getDistance.call(this,f))}};if(b.hasOwnProperty("polyline")&&Array.isArray(b.polyline))for(p=0;p<b.polyline.length;p+=1)if(c=b.polyline[p],c.hasOwnProperty("coords")&&Array.isArray(c.coords)){k=
new google.maps.MVCArray;for(l=0;l<c.coords.length;l+=1)g=c.coords[l],g=q(g,!0),"function"===typeof g.lat&&k.push(g);g=h.extend({},{strokeColor:c.color||"#FF0000",strokeOpacity:c.opacity||1,strokeWeight:c.width||2},c);e=new google.maps.Polyline(g);this._polylines.push(e);if(2<k.getLength())for(l=0;l<k.length;l+=1)0<l&&k.length-1>l&&d.push({location:k.getAt(l),stopover:!1});e&&g.hasOwnProperty("event")&&g.event.hasOwnProperty("created")&&"function"===typeof g.event.created&&g.event.created.call(e,
...
2===a.icon.anchor.length&&(b.anchor=this.formatPoint(a.icon.anchor))}return b},markerDirect:function(a,b){var c={},d={},e=b.hasOwnProperty("id")?b.id:"",c=b.hasOwnProperty("title")?b.title.toString().replace(/<([^>]+)>/g,""):!1,f=b.hasOwnProperty("text")?b.text.toString():!1,g=this.markerIcon(b),k={},m=h.extend({},{map:a,position:b.parseAddr,animation:null,id:e},b);c&&(m.title=c);f&&(k.content=f,b.hasOwnProperty("infoWindowOptions")&&(k=h.extend({},k,b.infoWindowOptions),k.hasOwnProperty("pixelOffset")&&
Array.isArray(k.pixelOffset)&&(k.pixelOffset=this.formatSize(k.pixelOffset))),m.text=f,m.infoWindow=new google.maps.InfoWindow(k));h.isEmptyObject(g)||(m.icon=g);b.hasOwnProperty("animation")&&"string"===typeof b.animation&&(m.animation=google.maps.Animation[b.animation.toUpperCase()]);m=h.extend({},b,m);c="function"===typeof MarkerWithLabel?new MarkerWithLabel(m):new google.maps.Marker(m);this._markers.push(c);c&&b.hasOwnProperty("event")&&b.event.hasOwnProperty("created")&&"function"===typeof b.event.created&&
b.event.created.call(c,this);c.hasOwnProperty("position")&&("function"===typeof c.getPosition&&this._bounds.extend(c.position),this.options.hasOwnProperty("markerFitBounds")&&!0===this.options.markerFitBounds&&this._markers.length===this.options.marker.length&&a.fitBounds(this._bounds));(!b.hasOwnProperty("cluster")||b.hasOwnProperty("cluster")&&!0===b.cluster)&&"function"===typeof this._clusters.addMarker&&this._clusters.addMarker(c);b.hasOwnProperty("newLabel")&&(d=new v({text:b.newLabel,map:a,
css:b.hasOwnProperty("newLabelCSS")?b.newLabelCSS.toString():"",id:e}),d.bindTo("position",c,"position"),d.bindTo("visible",c),this._labels.push(d));google.maps.event.addListener(c,"map_changed",function(){"function"===typeof d.setMap&&d.setMap(this.getMap())});this.bindEvents(c,b.event)},markerGeocoder:function(a,b,c){var d=this;(new google.maps.Geocoder).geocode({address:b.parseAddr},function(e,f){if(f===google.maps.GeocoderStatus.OVER_QUERY_LIMIT)u.setTimeout(function(){d.markerGeocoder(a,b)},
d.interval);else if(f===google.maps.GeocoderStatus.OK){var g={},k={},m=b.hasOwnProperty("id")?b.id:"",g=b.hasOwnProperty("title")?b.title.toString().replace(/<([^>]+)>/g,""):!1,p=b.hasOwnProperty("text")?b.text.toString():!1,l={map:a,position:e[0].geometry.location,animation:null,visible:!0,id:m},q=d.markerIcon(b);g&&(l.title=g);p&&(l.text=p,l.infoWindow=new google.maps.InfoWindow({content:p}));h.isEmptyObject(q)||(l.icon=q);b.hasOwnProperty("animation")&&"string"===typeof b.animation&&(l.animation=
google.maps.Animation[b.animation.toUpperCase()]);l=h.extend({},b,l);g="function"===typeof MarkerWithLabel?new MarkerWithLabel(l):new google.maps.Marker(l);d._markers.push(g);g&&b.hasOwnProperty("event")&&b.event.hasOwnProperty("created")&&"function"===typeof b.event.created&&b.event.created.call(g,d);g.hasOwnProperty("position")&&("function"===typeof g.getPosition&&d._bounds.extend(g.position),d.options.hasOwnProperty("markerFitBounds")&&!0===d.options.markerFitBounds&&d._markers.length===c.marker.length&&
a.fitBounds(d._bounds));(!b.hasOwnProperty("cluster")||b.hasOwnProperty("cluster")&&!0===b.cluster)&&"function"===typeof d._clusters.addMarker&&d._clusters.addMarker(g);b.hasOwnProperty("newLabel")&&(k=new v({text:b.newLabel,map:d.map,css:b.hasOwnProperty("newLabelCSS")?b.newLabelCSS.toString():"",id:m}),k.bindTo("position",g,"position"),k.bindTo("text",g,"position"),k.bindTo("visible",g),d._labels.push(k));google.maps.event.addListener(g,"map_changed",function(){"function"===typeof k.setMap&&k.setMap(this.getMap())});
d.bindEvents(g,b.event)}})},direction:function(a,b){var c=0;if(b.hasOwnProperty("direction")&&Array.isArray(b.direction))for(c=0;c<b.direction.length;c+=1)"undefined"!==typeof b.direction[c]&&this.directionService(b.direction[c])},directionService:function(a){if(!a.hasOwnProperty("from")||!a.hasOwnProperty("to"))return!1;var b=this,c=new google.maps.DirectionsService,d=new google.maps.DirectionsRenderer,e={},f=[],g=[],k=new google.maps.InfoWindow,m=[],p={},l="",r="",n={travelMode:google.maps.DirectionsTravelMode.DRIVING,
optimizeWaypoints:a.hasOwnProperty("optimize")?a.optimize:!0};i=0;n.origin=q(a.from,!0);n.destination=q(a.to,!0);p=h.extend({},{infoWindow:k,map:b.map},a);a.hasOwnProperty("travel")&&google.maps.TravelMode[a.travel.toString().toUpperCase()]&&(n.travelMode=google.maps.TravelMode[a.travel.toString().toUpperCase()]);a.hasOwnProperty("panel")&&h(a.panel).length&&(p.panel=h(a.panel).get(0));if(a.hasOwnProperty("waypoint")&&Array.isArray(a.waypoint)){for(i=0;i<a.waypoint.length;i+=1)e={},"string"===typeof a.waypoint[i]||
Array.isArray(a.waypoint[i])?e={location:q(a.waypoint[i],!0),stopover:!0}:(a.waypoint[i].hasOwnProperty("location")&&(e.location=q(a.waypoint[i].location,!0)),e.stopover=a.waypoint[i].hasOwnProperty("stopover")?a.waypoint[i].stopover:!0),f.push(a.waypoint[i].text||a.waypoint[i].toString()),a.waypoint[i].hasOwnProperty("icon")&&g.push(a.waypoint[i].icon.toString()),m.push(e);n.waypoints=m}c.route(n,function(c,e){var h=[],m={},n=0;if(e===google.maps.DirectionsStatus.OK){h=c.routes[0].legs;try{a.hasOwnProperty("fromText")&&
(l=h[0].start_address=a.fromText);a.hasOwnProperty("toText")&&(1===h.length?h[0].end_address=a.toText:h[h.length-1].end_address=a.toText,r=a.toText);a.hasOwnProperty("icon")&&(p.suppressMarkers=!0,a.icon.hasOwnProperty("from")&&"string"===typeof a.icon.from&&b.directionServiceMarker(h[0].start_location,{icon:a.icon.from,text:l},k,a),a.icon.hasOwnProperty("to")&&"string"===typeof a.icon.to&&b.directionServiceMarker(h[h.length-1].end_location,{icon:a.icon.to,text:r},k,a));for(n=0;n<h.length;n+=1)a.hasOwnProperty("icon")&&
(a.icon.hasOwnProperty("waypoint")&&"string"===typeof a.icon.waypoint?m.icon=a.icon.waypoint:"string"===typeof g[n-1]&&(m.icon=g[n-1]),m.text=f[n-1],b.directionServiceMarker(h[n].start_location,m,k,a));a.hasOwnProperty("event")&&a.event.hasOwnProperty("created")&&"function"===typeof a.event.created&&a.event.created.call(b,d,c)}catch(q){}b.bindEvents(d,a.event);d.setOptions(p);d.setDirections(c)}});b._directions.push(d)},directionServiceMarker:function(a,b,c,d){var e=this,f={},g=h.extend({},{position:a,
map:e.map,id:d.hasOwnProperty("id")?d.id:""},b),k=new google.maps.Marker(g);g.hasOwnProperty("text")&&(f=function(){c.setPosition(a);c.setContent(g.text);c.open(e.map,k)});e._directionsMarkers.push(k);e.bindEvents(k,f)},getDirectionsInfo:function(){var a=[],b=null,c=this._directions,d=0,e=0,f=0,g=0;if(c)for(f=0,d=c.length;f<d;f+=1)if(c[f].hasOwnProperty("directions")&&c[f].directions.hasOwnProperty("routes")&&"undefined"!==typeof c[f].directions.routes[0].legs)for(b=c[f].directions.routes[0].legs,
a[f]=[],g=0,e=b.length;g<e;g+=1)a[f].push({from:b[g].start_address,to:b[g].end_address,distance:b[g].distance,duration:b[g].duration});return a},streetView:function(a,b){var c=b.hasOwnProperty("streetViewObj")?b.streetViewObj:{},d={},d={};"function"===typeof a.getStreetView&&(c.hasOwnProperty("position")?(d=q(c.position,!0),c.position="object"===typeof d?a.getCenter():d):c.position=a.getCenter(),c.hasOwnProperty("pov")&&(c.pov=h.extend({},{heading:0,pitch:0,zoom:1},c.pov)),d=a.getStreetView(),d.setOptions(c),
c.hasOwnProperty("event")&&this.bindEvents(d,c.event),c.hasOwnProperty("visible")&&d.setVisible(c.visible))},places:function(a,b){var c=this,d={},d=b.hasOwnProperty("places")?b.places:{},e=h.extend({},{location:a.getCenter(),radius:100},d),f=0;e.location=q(e.location,!0);"undefined"!==typeof google.maps.places&&(d=new google.maps.places.PlacesService(a),d.nearbySearch(e,function(b,d){if(d===google.maps.places.PlacesServiceStatus.OK){c._places.push(b);if(e.hasOwnProperty("createMarker")&&!0===e.createMarker)for(f=
0;f<b.length;f+=1)b[f].hasOwnProperty("geometry")&&c._markers.push(new google.maps.Marker({map:a,position:b[f].geometry.location}));e.hasOwnProperty("callback")&&"function"===typeof e.callback&&e.callback.call(b)}}))},geoLocation:function(a,b){try{var c=this,d=navigator.geolocation,e={};d&&(b.hasOwnProperty("geolocation")&&(e=h.extend({},{maximumAge:6E5,timeout:3E3,enableHighAccuracy:!1},b.geolocation)),!0!==b.autoLocation&&"function"!==typeof b.autoLocation||d.getCurrentPosition(function(d){"undefined"!==
...
a.length?a[0].hasOwnProperty("geometry")&&b.panTo(a[0].geometry.location):console.error(c)})):"function"===typeof b.panTo&&b.panTo(c));return h(this.container)},close:function(a,b){var c=this.get(a),d={},e={},f="",g=0;c.hasOwnProperty("map")&&delete c.map;Array.isArray(c)?e[a]=c:e=c;try{for(f in e)if(Array.isArray(e[f]))for(g=0;g<e[f].length;g+=1)d=e[f][g],d.hasOwnProperty("infoWindow")&&"function"===typeof d.infoWindow.close&&d.infoWindow.close();"function"===typeof b&&b.call(this)}catch(k){console.warn(k)}finally{return h(this.container)}},
clear:function(a,b){var c=this._directionsMarkers,d=this._labels,e=this.get(a),f={},g={},k="",m=0;e.hasOwnProperty("map")&&delete e.map;Array.isArray(e)?f[a]=e:f=e;try{for(k in f)if(key="_"+k.toString().toLowerCase()+"s",Array.isArray(f[k])){for(m=0;m<f[k].length;m+=1){g=f[k][m];"marker"===k&&"undefined"!==typeof d[m]&&d.hasOwnProperty("div")&&this._labels[m].div.remove();if("direction"===k){for(j=0;j<c.length;j+=1)"function"===typeof c[j].setMap&&this._directionsMarkers[j].setMap(null);this._directionsMarkers.filter(function(a){return w!==
a})}"function"===typeof g.set&&g.set("visible",!1);"function"===typeof g.setMap&&g.setMap(null);this[key][m]=w}this[key]=this[key].filter(function(a){return w!==a})}"function"===typeof b&&b.call(this)}catch(p){console.warn(p)}finally{return h(this.container)}},get:function(a,b){var c=[],d={},e={},f={},g="",k="",h=0;"undefined"===typeof a&&(a={marker:[],label:[],polygon:[],polyline:[],circle:[],direction:[],kml:[],cluster:[],bound:[]});try{if("string"===typeof a)if(~a.indexOf(","))for(c=a.replace(/\s/gi,
"").split(","),h=0;h<c.length;h+=1)k=c[h].toString().toLowerCase(),"map"===k?d[k]=this.map:(g="_"+k+"s",d[k]=this[g]);else"map"===a.toString().toLowerCase()?d=this.map:(g="_"+a.toString().toLowerCase()+"s",d=this[g]);else{for(f in a)if(Array.isArray(a[f])&&(g="_"+f.toString().toLowerCase()+"s",Array.isArray(this[g])))for(d[f]=[],h=0;h<this[g].length;h+=1)e=this[g][h],(0===a[f].length||-1!==a[f].indexOf(h)||e.hasOwnProperty("id")&&0<e.id.length&&~a[f].indexOf(e.id))&&d[f].push(e);d.map=this.map}"function"===
typeof b&&b.call(this,d)}catch(p){console.warn(p)}finally{return d}},modify:function(a){var b=[],c=[["kml","kml"],["marker","markers"],["direction","direction"],["polyline","drawPolyline"],["polygon","drawPolygon"],["circle","drawCircle"],["streetView","streetView"],["markerFitBounds","markerFitBounds"],["places","places"]],d=0,e=this.map;if("undefined"!==typeof a){for(d=0;d<c.length;d+=1)a.hasOwnProperty(c[d][0])&&b.push(c[d][1]);if(null!==e){if(b.length)for(d=0;d<b.length;d+=1)"function"===typeof this[b[d]]&&
("streetView"===b[d]&&(a.streetViewObj=a.streetView,delete a.streetView),this[b[d]](e,a,"modify"));else e.setOptions(a);a.hasOwnProperty("event")&&this.bindEvents(e,a.event);google.maps.event.trigger(e,"resize")}}return h(this.container)},destroy:function(){var a=h(this.container);a.length&&h.removeData(this.container,"tinyMap");return a.empty()},getKML:function(a){var b=h(this.container).data("tinyMap");a=h.extend({},{marker:!0,polyline:!0,direction:!0,download:!1},a);var c='<?xml version="1.0" encoding="UTF-8"?>;<kml xmlns="http://earth.google.com/kml/2.2">;<Document>;<name><![CDATA[]]\x3e</name>;<description><![CDATA[]]\x3e</description>;<Style id="style1">;<IconStyle>;<Icon>;<href>//maps.google.com/mapfiles/kml/paddle/grn-circle_maps.png</href>;</Icon>;</IconStyle>;</Style>;#PLACEMARKS#;</Document>;</kml>'.split(";"),
d="<Placemark> <name><![CDATA[]]\x3e</name> <Snippet></Snippet> <description><![CDATA[]]\x3e</description> <styleUrl>#style1</styleUrl> <ExtendedData> </ExtendedData> #DATA# </Placemark>".split(" "),e=[],f=[],f=[],g="",k="",m="",p="",p="",l=[],q=[],l={},n=0,r=e=-1,t=-1;if(b){if(!0===a.marker)for(e=b._markers,n=0;n<length;n+=1)p=e[n].position.lng()+","+e[n].position.lat(),g+=d.join("").replace(/#DATA#/gi,"<Point><coordinates>#LATLNG#,0.000000</coordinates></Point>".replace(/#LATLNG#/gi,p));if(!0===
a.polyline)for(f=b._polylines,n=0;n<f.length;n+=1){l=f[n].getPath().getArray();p="";for(e=0;e<l.length;e+=1)p+=l[e].lng()+","+l[e].lat()+",0.000000\n";k+=d.join("").replace(/#DATA#/gi,"<LineString><tessellate>1</tessellate><coordinates>#LATLNG#</coordinates></LineString>".replace(/#LATLNG#/gi,p))}if(!0===a.direction)for(f=b._directions,n=0;n<f.length;n+=1)if(f[n].hasOwnProperty("directions")&&f[n].directions.hasOwnProperty("routes")&&Array.isArray(f[n].directions.routes)&&0<f[n].directions.routes.length&&
f[n].directions.routes[0].hasOwnProperty("legs")&&Array.isArray(f[n].directions.routes[0].legs))for(l=f[n].directions.routes[0].legs,e=0;e<l.length;e+=1)if(Array.isArray(l[e].steps))for(r=0;e<l[e].steps.length;r+=1){p="";if(Array.isArray(l[e].steps[r].path))for(t=0;t<l[e].steps[r].path.length;t+=1)q=l[e].steps[r].path[t],"undefined"!==typeof q&&"function"===typeof q.lat&&(p+=q.lng()+","+q.lat()+",0.000000\n");m+=d.join("").replace(/#DATA#/gi,"<LineString><tessellate>1</tessellate><coordinates>#LATLNG#</coordinates></LineString>".replace(/#LATLNG#/gi,
p))}p=c.join("").replace(/#PLACEMARKS#/gi,g+k+m);if(!0===a.download)u.open("data:application/vnd.google-earth.kml+xml;charset=utf-8;base64,"+u.btoa(u.decodeURIComponent(u.encodeURIComponent(p))));else return p}},init:function(){var a=this,b={},b={},c=h.extend({},t),d=c.api.split("?")[0],e="",f={};try{delete c.api,delete c.clusterer,delete c.withLabel,c=h.param(c)}catch(g){}z||"undefined"!==typeof u.google||(b=r.createElement("script"),b.setAttribute("src",[d,c].join("?")),(r.getElementsByTagName("head")[0]||
...
a.googleMapOptions),google.maps.event.addListenerOnce(a.map,"idle",function(){a.overlay();google.maps.event.trigger(a.map,"resize")}),a.bindEvents(a.map,a.options.event))}}};h.fn.tinyMapConfigure=function(a){t=h.extend(t,a)};h.fn.tinyMapDistance=function(a,b){var c={key:t.hasOwnProperty("key")?t.key:"",origins:[],destinations:[],language:"zh-TW"},c=h.extend({},c,a);Array.isArray(c.origins)&&(c.origins=c.origins.join("|"));Array.isArray(c.destinations)&&(c.destinations=c.destinations.join("|"));h.getJSON("//maps.googleapis.com/maps/api/distancematrix/json",
c,function(a){"OK"===a.status&&b.cal(this,a)})};h.fn.tinyMapQuery=function(a,b){var c={key:t.hasOwnProperty("key")?t.key:"",language:"zh-TW"},d=h.extend({},c,a),e=null;h.getJSON("//maps.googleapis.com/maps/api/geocode/json",d,function(a){"OK"===a.status&&a.results&&"undefined"!==typeof a.results[0]&&(d.hasOwnProperty("latlng")?e=a.results[0].formatted_address:d.hasOwnProperty("address")&&(e=[a.results[0].geometry.location.lat,a.results[0].geometry.location.lng].join()),b.call(this,e))})};h.fn.tinyMap=
