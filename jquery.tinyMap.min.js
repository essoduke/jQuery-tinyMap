...
C={autoLocation:!1,center:[24,121],infoWindowAutoClose:!0,interval:200,loading:"\u8b80\u53d6\u4e2d&hellip;",notFound:"\u627e\u4e0d\u5230\u67e5\u8a62\u7684\u5730\u9ede",zoom:8},y={},y={greyscale:[{featureType:"all",stylers:[{saturation:-100},{gamma:.5}]}]};x.prototype={VERSION:"3.2.17",formatSize:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Size(a[0],a[1]):a},formatPoint:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Point(a[0],a[1]):a},overlay:function(){var a=
...
{},h={},l=b.hasOwnProperty("id")?b.id:"",g=b.hasOwnProperty("title")?b.title.toString().replace(/<([^>]+)>/g,""):!1,p=b.hasOwnProperty("text")?b.text.toString():!1,m={map:a,position:e[0].geometry.location,animation:null,visible:!0,id:l},q=d.markerIcon(b);g&&(m.title=g);p&&(m.text=p,m.infoWindow=new google.maps.InfoWindow({content:p}));k.isEmptyObject(q)||(m.icon=q);b.hasOwnProperty("animation")&&"string"===typeof b.animation&&(m.animation=google.maps.Animation[b.animation.toUpperCase()]);g="function"===
typeof MarkerWithLabel?new MarkerWithLabel(m):new google.maps.Marker(m);d._markers.push(g);g&&b.hasOwnProperty("event")&&b.event.hasOwnProperty("created")&&"function"===typeof b.event.created&&b.event.created.call(g,d);g.hasOwnProperty("position")&&("function"===typeof g.getPosition&&d._bounds.extend(g.position),d.options.hasOwnProperty("markerFitBounds")&&!0===d.options.markerFitBounds&&d._markers.length===c.marker.length&&a.fitBounds(d._bounds));(!b.hasOwnProperty("cluster")||b.hasOwnProperty("cluster")&&
!0===b.cluster)&&"function"===typeof d._clusters.addMarker&&d._clusters.addMarker(g);b.hasOwnProperty("newLabel")&&(h=new v({text:b.newLabel,map:d.map,css:b.hasOwnProperty("newLabelCSS")?b.newLabelCSS.toString():"",id:l}),h.bindTo("position",g,"position"),h.bindTo("text",g,"position"),h.bindTo("visible",g),d._labels.push(h));google.maps.event.addListener(g,"map_changed",function(){"function"===typeof h.setMap&&h.setMap(this.getMap())});d.bindEvents(g,b.event)}})},direction:function(a,b){var c=0;if(b.hasOwnProperty("direction")&&
Array.isArray(b.direction))for(c=0;c<b.direction.length;c+=1)"undefined"!==typeof b.direction[c]&&this.directionService(b.direction[c])},directionService:function(a){if(!a.hasOwnProperty("from")||!a.hasOwnProperty("to"))return!1;var b=this,c=new google.maps.DirectionsService,d=new google.maps.DirectionsRenderer,e={},f=[],g=[],h=new google.maps.InfoWindow,l=[],p={},m="",r="",n={travelMode:google.maps.DirectionsTravelMode.DRIVING,optimizeWaypoints:a.hasOwnProperty("optimize")?a.optimize:!0};i=0;n.origin=
q(a.from,!0);n.destination=q(a.to,!0);p=k.extend({},{infoWindow:h,map:b.map},a);a.hasOwnProperty("travel")&&google.maps.TravelMode[a.travel.toString().toUpperCase()]&&(n.travelMode=google.maps.TravelMode[a.travel.toString().toUpperCase()]);a.hasOwnProperty("panel")&&k(a.panel).length&&(p.panel=k(a.panel).get(0));if(a.hasOwnProperty("waypoint")&&Array.isArray(a.waypoint)){for(i=0;i<a.waypoint.length;i+=1)e={},"string"===typeof a.waypoint[i]||Array.isArray(a.waypoint[i])?e={location:q(a.waypoint[i],
!0),stopover:!0}:(a.waypoint[i].hasOwnProperty("location")&&(e.location=q(a.waypoint[i].location,!0)),e.stopover=a.waypoint[i].hasOwnProperty("stopover")?a.waypoint[i].stopover:!0),f.push(a.waypoint[i].text||a.waypoint[i].toString()),a.waypoint[i].hasOwnProperty("icon")&&g.push(a.waypoint[i].icon.toString()),l.push(e);n.waypoints=l}c.route(n,function(c,e){var l=[],k={},n=0;if(e===google.maps.DirectionsStatus.OK){l=c.routes[0].legs;try{for(a.hasOwnProperty("fromText")&&(m=l[0].start_address=a.fromText),
a.hasOwnProperty("toText")&&(1===l.length?l[0].end_address=a.toText:l[l.length-1].end_address=a.toText,r=a.toText),a.hasOwnProperty("icon")&&(p.suppressMarkers=!0,a.icon.hasOwnProperty("from")&&"string"===typeof a.icon.from&&b.directionServiceMarker(l[0].start_location,{icon:a.icon.from,text:m},h,a),a.icon.hasOwnProperty("to")&&"string"===typeof a.icon.to&&b.directionServiceMarker(l[l.length-1].end_location,{icon:a.icon.to,text:r},h,a)),n=0;n<l.length;n+=1)a.hasOwnProperty("icon")&&(a.icon.hasOwnProperty("waypoint")&&
"string"===typeof a.icon.waypoint?k.icon=a.icon.waypoint:"string"===typeof g[n-1]&&(k.icon=g[n-1]),k.text=f[n-1],b.directionServiceMarker(l[n].start_location,k,h,a))}catch(q){}b.bindEvents(d,a.event);d.setOptions(p);d.setDirections(c)}});b._directions.push(d)},directionServiceMarker:function(a,b,c,d){var e=this,f={},g=k.extend({},{position:a,map:e.map,id:d.hasOwnProperty("id")?d.id:""},b),h=new google.maps.Marker(g);g.hasOwnProperty("text")&&(f=function(){c.setPosition(a);c.setContent(g.text);c.open(e.map,
h)});e._directionsMarkers.push(h);e.bindEvents(h,f)},getDirectionsInfo:function(){var a=[],b=null,c=this._directions,d=0,e=0,f=0,g=0;if(c)for(f=0,d=c.length;f<d;f+=1)if(c[f].hasOwnProperty("directions")&&c[f].directions.hasOwnProperty("routes")&&"undefined"!==typeof c[f].directions.routes[0].legs)for(b=c[f].directions.routes[0].legs,a[f]=[],g=0,e=b.length;g<e;g+=1)a[f].push({from:b[g].start_address,to:b[g].end_address,distance:b[g].distance,duration:b[g].duration});return a},streetView:function(a,
b){var c=b.hasOwnProperty("streetViewObj")?b.streetViewObj:{},d={},d={};"function"===typeof a.getStreetView&&(c.hasOwnProperty("position")?(d=q(c.position,!0),c.position="object"===typeof d?a.getCenter():d):c.position=a.getCenter(),c.hasOwnProperty("pov")&&(c.pov=k.extend({},{heading:0,pitch:0,zoom:1},c.pov)),d=a.getStreetView(),d.setOptions(c),c.hasOwnProperty("event")&&this.bindEvents(d,c.event),c.hasOwnProperty("visible")&&d.setVisible(c.visible))},places:function(a,b){var c=this,d={},d=b.hasOwnProperty("places")?
b.places:{},e=k.extend({},{location:a.getCenter(),radius:100},d),f=0;e.location=q(e.location,!0);"undefined"!==typeof google.maps.places&&(d=new google.maps.places.PlacesService(a),d.nearbySearch(e,function(b,d){if(d===google.maps.places.PlacesServiceStatus.OK){c._places.push(b);if(e.hasOwnProperty("createMarker")&&!0===e.createMarker)for(f=0;f<b.length;f+=1)b[f].hasOwnProperty("geometry")&&c._markers.push(new google.maps.Marker({map:a,position:b[f].geometry.location}));e.hasOwnProperty("callback")&&
"function"===typeof e.callback&&e.callback.call(b)}}))},geoLocation:function(a,b){try{var c=this,d=navigator.geolocation,e={};d&&(b.hasOwnProperty("geolocation")&&(e=k.extend({},{maximumAge:6E5,timeout:3E3,enableHighAccuracy:!1},b.geolocation)),!0!==b.autoLocation&&"function"!==typeof b.autoLocation||d.getCurrentPosition(function(d){"undefined"!==typeof d&&"coords"in d&&"latitude"in d.coords&&"longitude"in d.coords&&(a.panTo(new google.maps.LatLng(d.coords.latitude,d.coords.longitude)),"function"===
typeof b.autoLocation&&b.autoLocation.call(c,d))},function(a){console.error(a)},e))}catch(f){}},panTo:function(a){var b=this.map,c={},d={};null!==b&&"undefined"!==typeof b&&(c=q(a,!0),"string"===typeof c?(d=new google.maps.Geocoder,d.geocode({address:c},function(a,c){c===google.maps.GeocoderStatus.OK&&"function"===typeof b.panTo&&Array.isArray(a)&&a.length?a[0].hasOwnProperty("geometry")&&b.panTo(a[0].geometry.location):console.error(c)})):"function"===typeof b.panTo&&b.panTo(c));return k(this.container)},
