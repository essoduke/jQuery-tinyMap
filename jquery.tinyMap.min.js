...
0;c<k.length;c+=1)a.marker[e].id===k[c].id&&g(a.marker[e],"addr")?(k[c].setPosition(new google.maps.LatLng(a.marker[e].addr[0],a.marker[e].addr[1])),g(a.marker[e],"text")&&(g(k[c],"infoWindow")?"function"===typeof k[c].infoWindow.setContent&&k[c].infoWindow.setContent(a.marker[e].text):(k[c].infoWindow=new google.maps.InfoWindow({content:a.marker[e].text}),this.bindEvents(k[c],a.marker[e].event))),g(a.marker[e],"icon")&&k[c].setIcon(a.marker[e].icon)):g(a.marker[e],"addr")&&(a.marker[e].parseAddr=
q(a.marker[e].addr,!0),"string"===typeof a.marker[e].parseAddr?this.markerByGeocoder(b,a.marker[e]):this.markerDirect(b,a.marker[e]));c=0;for(n=p.length;c<n;c+=1)a.marker[e].id===p[c].id&&(g(a.marker[e],"label")&&(p[c].text=a.marker[e].label),p[c].draw())}else g(a.marker[e],"addr")&&(a.marker[e].parseAddr=q(a.marker[e].addr,!0),"string"===typeof a.marker[e].parseAddr?this.markerByGeocoder(b,a.marker[e]):this.markerDirect(b,a.marker[e]));if(g(a,"markerCluster")&&!0===a.markerCluster&&"function"===
typeof MarkerClusterer)return new MarkerClusterer(b,this._markers)},drawPolyline:function(b,a){var d={},c=0,f={},e={},f={},n=0,k=0,f={},p=[],f={},v=[],r={};if(g(a,"polyline")&&h.isArray(a.polyline))for(k=a.polyline.length-1;0<=k;--k)if(e=a.polyline[k],g(e,"coords")&&h.isArray(e.coords)){for(var m=new google.maps.MVCArray,c=0;c<e.coords.length;c+=1)f=e.coords[c],f=q(f,!0),"function"===typeof f.lat&&m.push(f);f=h.extend({},{strokeColor:e.color||"#FF0000",strokeOpacity:1,strokeWeight:e.width||2},e);
d=new google.maps.Polyline(f);this._polylines.push(d);if(2<m.getLength())for(c=0;c<m.length;c+=1)0<c&&m.length-1>c&&v.push({location:m.getAt(c),stopover:!1});g(e,"event")&&self.bindEvents(d,e.event);g(e,"snap")&&!0===e.snap?(f=new google.maps.DirectionsService,f.route({origin:m.getAt(0),waypoints:v,destination:m.getAt(m.length-1),travelMode:google.maps.DirectionsTravelMode.DRIVING},function(a,b){if(b===google.maps.DirectionsStatus.OK){c=0;for(n=a.routes[0].overview_path;c<n.length;c+=1)p.push(n[c]);
d.setPath(p);"function"===typeof e.getDistance&&(r=a.routes[0].legs[0].distance,e.getDistance.call(this,r))}})):(d.setPath(m),g(google.maps,"geometry")&&g(google.maps.geometry,"spherical")&&"function"===typeof google.maps.geometry.spherical.computeDistanceBetween&&(r=google.maps.geometry.spherical.computeDistanceBetween(m.getAt(0),m.getAt(m.length-1)),"function"===typeof e.getDistance&&e.getDistance.call(this,r)));d.setMap(b)}},drawPolygon:function(b,a){var d={},c=0,d=0,f={},f={},e=0,d={},n=[];if(g(a,
"polygon")&&h.isArray(a.polygon))for(e=a.polygon.length;c<e;c+=1)if(g(a.polygon[c],"coords")){for(d=0;d<a.polygon[c].coords.length;d+=1)f=a.polygon[c].coords[d],f=q(f,!0),"function"===typeof f.lat&&n.push(f);d=h.extend({},{path:n,strokeColor:a.polygon[c].color||"#FF0000",strokeOpacity:1,strokeWeight:a.polygon[c].width||2,fillColor:a.polygon[c].fillcolor||"#CC0000",fillOpacity:.35},a.polygon[c]);d=new google.maps.Polygon(d);g(a.polygon[c],"event")&&this.bindEvents(d,a.polygon[c].event);this._polygons.push(d);
d.setMap(b)}},drawCircle:function(b,a){var d=0,c={},f={},e={},f={};if(g(a,"circle")&&h.isArray(a.circle))for(d=a.circle.length-1;0<=d;--d)e=a.circle[d],f=h.extend({},{map:b,strokeColor:e.color||"#FF0000",strokeOpacity:e.opacity||.8,strokeWeight:e.width||2,fillColor:e.fillcolor||"#FF0000",fillOpacity:e.fillopacity||.35,radius:e.radius||10,zIndex:100,id:g(e,"id")?e.id:""},e),g(e,"center")&&(c=q(e.center,!0),f.center=c),"function"===typeof c.lat&&(f=new google.maps.Circle(f),this._circles.push(f),g(e,
"event")&&this.bindEvents(f,e.event))},overlay:function(){var b=this.map,a=this.options;try{this.kml(b,a),this.direction(b,a),this.markers(b,a),this.drawPolyline(b,a),this.drawPolygon(b,a),this.drawCircle(b,a),this.streetView(b,a),this.geoLocation(b,a)}catch(d){console.dir(d)}},markerIcon:function(b){var a=h.extend({},a,b.icon);if(g(b,"icon")){if("string"===typeof b.icon)return b.icon;g(b.icon,"url")&&(a.url=b.icon.url);g(b.icon,"size")&&h.isArray(b.icon.size)&&2===b.icon.size.length&&(a.size=new google.maps.Size(b.icon.size[0],
b.icon.size[1]));g(b.icon,"scaledSize")&&h.isArray(b.icon.scaledSize)&&2===b.icon.scaledSize.length&&(a.scaledSize=new google.maps.Size(b.icon.scaledSize[0],b.icon.scaledSize[1]));g(b.icon,"anchor")&&h.isArray(b.icon.anchor)&&2===b.icon.anchor.length&&(a.anchor=new google.maps.Point(b.icon.anchor[0],b.icon.anchor[1]))}return a},markerDirect:function(b,a){var d={},c={},c={},c=g(a,"id")?a.id:"",d=g(a,"title")?a.title.toString().replace(/<([^>]+)>/g,""):!1,f=g(a,"text")?a.text.toString():!1,e=h.extend({},
{map:b,position:a.parseAddr,animation:null,id:c},a),n=this.markerIcon(a);d&&(e.title=d);f&&(e.text=f,e.infoWindow=new google.maps.InfoWindow({content:f}));h.isEmptyObject(n)||(e.icon=n);g(a,"animation")&&"string"===typeof a.animation&&(e.animation=google.maps.Animation[a.animation.toUpperCase()]);d=new google.maps.Marker(e);this._markers.push(d);g(d,"position")&&("function"===typeof d.getPosition&&this.bounds.extend(d.position),!0===this.options.markerFitBounds&&this._markers.length===this.options.marker.length&&
b.fitBounds(this.bounds));if(!0===this.options.markerCluster&&"function"===typeof MarkerClusterer&&z===this.options.marker.length)return new MarkerClusterer(b,this._markers);c={map:b,css:g(a,"css")?a.css.toString():"",id:c};"string"===typeof a.label&&0!==a.label.length&&(c.text=a.label,c=new u(c),c.bindTo("position",d,"position"),c.bindTo("text",d,"position"),c.bindTo("visible",d),this._labels.push(c));this.bindEvents(d,a.event)},markerByGeocoder:function(b,a){var d=this;(new google.maps.Geocoder).geocode({address:a.parseAddr},
function(c,f){if(f===google.maps.GeocoderStatus.OVER_QUERY_LIMIT)w.setTimeout(function(){d.markerByGeocoder(b,a)},d.interval);else if(f===google.maps.GeocoderStatus.OK){var e={},n={},n={},k=g(a,"id")?a.id:"",e=g(a,"title")?a.title.toString().replace(/<([^>]+)>/g,""):!1,n=g(a,"text")?a.text.toString():!1,k={map:b,position:c[0].geometry.location,animation:null,id:k},p=d.markerIcon(a);e&&(k.title=e);n&&(k.text=n,k.infoWindow=new google.maps.InfoWindow({content:n}));h.isEmptyObject(p)||(k.icon=p);g(a,
...
css:g(a,"css")?a.css.toString():""};"string"===typeof a.label&&0!==a.label.length&&(n.text=a.label,n=new u(n),n.bindTo("position",e,"position"),n.bindTo("text",e,"position"),n.bindTo("visible",e),d._labels.push(n));d.bindEvents(e,a.event)}})},directionService:function(b){if(g(b,"from")&&g(b,"to")){var a=this,d=new google.maps.DirectionsService,c=new google.maps.DirectionsRenderer,f={travelMode:google.maps.DirectionsTravelMode.DRIVING,optimizeWaypoints:g(b,"optimize")?b.optimize:!1},e={},n={},k=[],
p={},v=[],r={},m="",l=0,s=0;f.origin=q(b.from,!0);f.destination=q(b.to,!0);g(b,"travel")&&google.maps.TravelMode[b.travel.toString().toUpperCase()]&&(f.travelMode=google.maps.TravelMode[b.travel.toString().toUpperCase()]);g(b,"panel")&&(e=h(b.panel));if(g(b,"waypoint")&&h.isArray(b.waypoint)){l=0;for(s=b.waypoint.length;l<s;l+=1)p={},"string"===typeof b.waypoint[l]||h.isArray(b.waypoint[l])?p={location:q(b.waypoint[l],!0),stopover:!0}:(g(b.waypoint[l],"location")&&(p.location=q(b.waypoint[l].location,
!0)),p.stopover=g(b.waypoint[l],"stopover")?b.waypoint[l].stopover:!0),v.push(b.waypoint[l].text||b.waypoint[l].toString()),k.push(p);f.waypoints=k}d.route(f,function(d,f){var e=0,h=0;if(f===google.maps.DirectionsStatus.OK){e=d.routes[0].legs;g(b,"autoViewport")&&(n.preserveViewport=!1===b.autoViewport?!0:!1);try{for(g(b,"fromText")&&(e[0].start_address=b.fromText),g(b,"toText")&&(1===e.length?e[0].end_address=b.toText:e[e.length-1].end_address=b.toText),1===e.length?(r=e[0].end_location,m=e[0].end_address):
(r=e[e.length-1].end_location,m=e[e.length-1].end_address),g(b,"icon")&&(n.suppressMarkers=!0,g(b.icon,"from")&&"string"===typeof b.icon.from&&a.directionServiceMarker(e[0].start_location,{icon:b.icon.from,text:e[0].start_address}),g(b.icon,"to")&&"string"===typeof b.icon.to&&a.directionServiceMarker(r,{icon:b.icon.to,text:m})),h=0;h<e.length-1;h+=1)e[h].end_address=v[h],g(b,"icon")&&g(b.icon,"waypoint")&&a.directionServiceMarker(e[h].start_location,{icon:b.icon.waypoint,text:e[h].start_address})}catch(k){}a.bindEvents(c,
b.event);c.setOptions(n);c.setDirections(d)}});c.setMap(a.map);e.length&&c.setPanel(e.get(0));a._directions.push(c)}},directionServiceMarker:function(b,a){var d=h.extend({},{position:b,map:this.map},a),c={};g(d,"text")&&(d.infoWindow=new google.maps.InfoWindow({content:d.text}));c=new google.maps.Marker(d);this._directionsMarkers.push(c);this.bindEvents(c)},bindEvents:function(b,a){var d=this,c={};switch(typeof a){case "function":google.maps.event.addListener(b,"click",a);break;case "object":for(c in a)"function"===
...
m))}m=d.join("").replace(/#PLACEMARKS#/gi,p+q+r);if(!0===b.download)h("<a/>").attr({href:"data:application/vnd.google-earth.kml+xml;charset=utf-8;base64,"+w.btoa(unescape(encodeURIComponent(m))),download:"tinyMap.kml"}).css("display","none").appendTo("body").trigger("click");else return m}},geoLocation:function(b,a){var d=navigator.geolocation;d&&!0===a.autoLocation&&d.getCurrentPosition(function(a){a&&g(a,"coords")&&b.panTo(new google.maps.LatLng(a.coords.latitude,a.coords.longitude))},function(a){console.error(a)},
