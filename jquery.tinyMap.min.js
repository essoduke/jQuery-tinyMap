/*! jQuery tinyMap v3.3.20, Licensed MIT (c) essoduke.org | https://code.essoduke.org/tinyMap/ */
...
C={greyscale:[{featureType:"all",stylers:[{saturation:-100},{gamma:.5}]}]};B.prototype={VERSION:"3.3.20",formatSize:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Size(a[0],a[1]):a},formatPoint:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Point(a[0],a[1]):a},overlay:function(){var a=this.map,b=this.options;try{this.kml(a,b),this.directionService(a,b),this.placeMarkers(a,b),this.drawPolyline(a,b),this.drawPolygon(a,b),this.drawCircle(a,b),this.streetView(a,b),
