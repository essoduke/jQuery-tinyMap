...
h.extend({},{heading:0,pitch:0,zoom:1},c.pov)),d=a.getStreetView(),d.setOptions(c),c.hasOwnProperty("event")&&this.bindEvents(d,c.event),c.hasOwnProperty("visible")&&d.setVisible(c.visible))},places:function(a,b){var c=this,d={},d=b.hasOwnProperty("places")?b.places:{},e=h.extend({},{location:a.getCenter(),radius:100},d),f=0;e.location=q(e.location,!0);"undefined"!==typeof google.maps.places&&(d=new google.maps.places.PlacesService(a),d.nearbySearch(e,function(b,d){if(d===google.maps.places.PlacesServiceStatus.OK){c._places.push(b);
if(e.hasOwnProperty("createMarker")&&!0===e.createMarker)for(f=0;f<b.length;f+=1)b[f].hasOwnProperty("geometry")&&c._markers.push(new google.maps.Marker({map:a,position:b[f].geometry.location}));e.hasOwnProperty("callback")&&"function"===typeof e.callback&&e.callback.call(b)}}))},geoLocation:function(a,b){try{var c=this,d=navigator.geolocation,e={};d&&(b.hasOwnProperty("geolocation")&&(e=h.extend({},{maximumAge:6E5,timeout:3E3,enableHighAccuracy:!1},b.geolocation)),!0!==b.autoLocation&&"function"!==
...
typeof c[j].setMap&&this._directionsMarkers[j].setMap(null);this._directionsMarkers.filter(function(a){return w!==a})}"function"===typeof g.set&&g.set("visible",!1);"function"===typeof g.setMap&&g.setMap(null);this[key][p]=w}this[key]=this[key].filter(function(a){return w!==a})}"function"===typeof b&&b.call(this)}catch(l){console.warn(l)}finally{return h(this.container)}},get:function(a,b){var c=[],d={},e={},f={},g="",k="",h=0;"undefined"===typeof a&&(a={marker:[],label:[],polygon:[],polyline:[],
circle:[],direction:[],kml:[],cluster:[],bound:[]});try{if("string"===typeof a)if(~a.indexOf(","))for(c=a.replace(/\s/gi,"").split(","),h=0;h<c.length;h+=1)k=c[h].toString().toLowerCase(),"map"===k?d[k]=this.map:(g="_"+k+"s",d[k]=this[g]);else"map"===a.toString().toLowerCase()?d=this.map:(g="_"+a.toString().toLowerCase()+"s",d=this[g]);else{for(f in a)if(Array.isArray(a[f])&&(g="_"+f.toString().toLowerCase()+"s",Array.isArray(this[g])))for(d[f]=[],h=0;h<this[g].length;h+=1)e=this[g][h],(0===a[f].length||
-1!==a[f].indexOf(h)||e.hasOwnProperty("id")&&0<e.id.length&&~a[f].indexOf(e.id))&&d[f].push(e);d.map=this.map}"function"===typeof b&&b.call(this,d)}catch(l){console.warn(l)}finally{return d}},modify:function(a){var b=[],c=[["kml","kml"],["marker","markers"],["direction","direction"],["polyline","drawPolyline"],["polygon","drawPolygon"],["circle","drawCircle"],["streetView","streetView"],["markerFitBounds","markerFitBounds"],["places","places"]],d=0,e=this.map;if("undefined"!==typeof a){for(d=0;d<
