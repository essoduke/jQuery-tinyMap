/*! jQuery tinyMap v3.3.14, Licensed MIT (c) essoduke.org | http://app.essoduke.org/tinyMap/ */
...
"function"===typeof MarkerClusterer&&(f=g.extend({},f,b.markerCluster),d._clusters=new MarkerClusterer(a,[],f),f.hasOwnProperty("event")&&d.bindEvents(d._clusters,f.event));h.forEach(function(f){var h=q(f.addr,!0),n=d.markerIcon(f),m=!0,v=!1,t={},w={},B="undefined"!==typeof f.id?f.id:f.addr.toString().replace(/\s/g,""),l={id:B,map:a,animation:null},l=g.extend({},l,f);"modify"===c&&B&&d.get({marker:[B]},function(a){!Array.isArray(a.marker)||!a.marker.length||f.hasOwnProperty("forceInsert")&&!0===f.forceInsert||
(f=g.extend(a.marker[0],f),"function"===typeof d._clusters.removeMarker&&d._clusters.removeMarker(a.marker[0]),m=!1,v=!0)});f.hasOwnProperty("title")&&(l.title=f.title.toString().replace(/<([^>]+)>/g,""));g.isEmptyObject(n)||(l.icon=n);f.hasOwnProperty("animation")&&"string"===typeof f.animation&&(l.animation=google.maps.Animation[f.animation.toUpperCase()]);"string"===typeof h?(e=new google.maps.Geocoder,e.geocode({address:h},function(e,h){h===google.maps.GeocoderStatus.OVER_QUERY_LIMIT?setTimeout(function(){d.placeMarkers(a,
...
"string"===typeof b.icon.from&&c.directionServiceMarker(l[0].start_location,{icon:b.icon.from,text:r},k.infoWindow,b),b.icon.hasOwnProperty("to")&&"string"===typeof b.icon.to&&c.directionServiceMarker(l[l.length-1].end_location,{icon:b.icon.to,text:t},k.infoWindow,b));for(p=1;p<l.length;p+=1)b.hasOwnProperty("icon")&&(b.icon.hasOwnProperty("waypoint")&&"string"===typeof b.icon.waypoint?q.icon=b.icon.waypoint:"string"===typeof m[p-1]&&(q.icon=m[p-1]),q.text=n[p-1],c.directionServiceMarker(l[p].start_location,
