...
C={autoLocation:!1,center:[24,121],infoWindowAutoClose:!0,interval:200,loading:"\u8b80\u53d6\u4e2d&hellip;",notFound:"\u627e\u4e0d\u5230\u67e5\u8a62\u7684\u5730\u9ede",zoom:8},y={},y={greyscale:[{featureType:"all",stylers:[{saturation:-100},{gamma:.5}]}]};x.prototype={VERSION:"3.2.11",formatSize:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Size(a[0],a[1]):a},formatPoint:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Point(a[0],a[1]):a},overlay:function(){var a=
...
d="<Placemark> <name><![CDATA[]]\x3e</name> <Snippet></Snippet> <description><![CDATA[]]\x3e</description> <styleUrl>#style1</styleUrl> <ExtendedData> </ExtendedData> #DATA# </Placemark>".split(" "),e=[],f=[],f=[],g="",k="",p="",l="",l="",n=[],q=[],n={},m=0,r=e=-1,t=-1;if(b){if(!0===a.marker)for(e=b._markers,m=0;m<length;m+=1)l=e[m].position.lng()+","+e[m].position.lat(),g+=d.join("").replace(/#DATA#/gi,"<Point><coordinates>#LATLNG#,0.000000</coordinates></Point>".replace(/#LATLNG#/gi,l));if(!0===
a.polyline)for(f=b._polylines,m=0;m<f.length;m+=1){n=f[m].getPath().getArray();l="";for(e=0;e<n.length;e+=1)l+=n[e].lng()+","+n[e].lat()+",0.000000\n";k+=d.join("").replace(/#DATA#/gi,"<LineString><tessellate>1</tessellate><coordinates>#LATLNG#</coordinates></LineString>".replace(/#LATLNG#/gi,l))}if(!0===a.direction)for(f=b._directions,m=0;m<f.length;m+=1)if(f[m].hasOwnProperty("directions")&&f[m].directions.hasOwnProperty("routes")&&Array.isArray(f[m].directions.routes)&&0<f[m].directions.routes.length&&
f[m].directions.routes[0].hasOwnProperty("legs")&&Array.isArray(f[m].directions.routes[0].legs))for(n=f[m].directions.routes[0].legs,e=0;e<n.length;e+=1)if(Array.isArray(n[e].steps))for(r=0;e<n[e].steps.length;r+=1){l="";if(Array.isArray(n[e].steps[r].path))for(t=0;t<n[e].steps[r].path.length;t+=1)q=n[e].steps[r].path[t],"undefined"!==typeof q&&"function"===typeof q.lat&&(l+=q.lng()+","+q.lat()+",0.000000\n");p+=d.join("").replace(/#DATA#/gi,"<LineString><tessellate>1</tessellate><coordinates>#LATLNG#</coordinates></LineString>".replace(/#LATLNG#/gi,
l))}l=c.join("").replace(/#PLACEMARKS#/gi,g+k+p);if(!0===a.download)u.open("data:application/vnd.google-earth.kml+xml;charset=utf-8;base64,"+u.btoa(u.decodeURIComponent(u.encodeURIComponent(l))));else return l}},init:function(){var a=this,b={},b={},c=h.extend({},t),d=c.api.split("?")[0],e="",f={};try{delete c.api,delete c.clusterer,delete c.withLabel,c=h.param(c)}catch(g){}z||"undefined"!==typeof u.google||(b=r.createElement("script"),b.setAttribute("src",[d,c].join("?")),(r.getElementsByTagName("head")[0]||
