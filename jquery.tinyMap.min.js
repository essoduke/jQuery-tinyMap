/*! jQuery tinyMap v3.3.18, Licensed MIT (c) essoduke.org | https://code.essoduke.org/tinyMap/ */
...
google.maps.TravelMode[b.travel.toString().toUpperCase()]:google.maps.TravelMode.DRIVING;b.hasOwnProperty("panel")&&g(b.panel).length&&(l.panel=g(b.panel).get(0));b.hasOwnProperty("requestExtra")&&b.requestExtra&&(f=g.extend({},f,b.requestExtra));b.hasOwnProperty("optimize")&&(f.optimizeWaypoints=b.optimize);b.hasOwnProperty("waypoint")&&Array.isArray(b.waypoint)&&(b.waypoint.forEach(function(a){var b={stopover:!0};"string"===typeof a||Array.isArray(a)?b.location=q(a,!0):a.hasOwnProperty("location")&&
(b.location=q(a.location,!0),b.stopover=a.hasOwnProperty("stopover")?a.stopover:!0);p.push(a.text||a.toString());a.hasOwnProperty("icon")&&m.push(a.icon.toString());k.push(b)}),f.waypoints=k);d.route(f,function(d,g){g===google.maps.DirectionsStatus.OK&&(d.routes.forEach(function(h,g){b.hasOwnProperty("renderAll")&&!0===b.renderAll&&!0===f.provideRouteAlternatives&&new google.maps.DirectionsRenderer({map:a,directions:d,routeIndex:g});var k=h.legs,t="",q="",r={},u=0;b.hasOwnProperty("fromText")&&(t=
k[0].start_address=b.fromText);b.hasOwnProperty("toText")&&(1===k.length?k[0].end_address=b.toText:k[k.length-1].end_address=b.toText,q=b.toText);b.hasOwnProperty("icon")&&(l.suppressMarkers=!0,b.icon.hasOwnProperty("from")&&"string"===typeof b.icon.from&&c.directionServiceMarker(k[0].start_location,{icon:b.icon.from,text:t},l.infoWindow,b),b.icon.hasOwnProperty("to")&&"string"===typeof b.icon.to&&c.directionServiceMarker(k[k.length-1].end_location,{icon:b.icon.to,text:q},l.infoWindow,b));for(u=1;u<
k.length;u+=1)b.hasOwnProperty("icon")&&(b.icon.hasOwnProperty("waypoint")&&"string"===typeof b.icon.waypoint?r.icon=b.icon.waypoint:"string"===typeof m[u-1]&&(r.icon=m[u-1]),r.text=p[u-1],c.directionServiceMarker(k[u].start_location,r,l.infoWindow,b))}),c.bindEvents(h,b.event),h.setOptions(l),h.setDirections(d),c._directions.push(h))})}})},directionServiceMarker:function(a,b,c,d){var e=this,f={},h=g.extend({},{position:a,map:e.map,id:d.hasOwnProperty("id")?d.id:""},b),l=new google.maps.Marker(h);
h.hasOwnProperty("text")&&(f=function(){c.setPosition(a);c.setContent(h.text);c.open(e.map,l)});e._directionsMarkers.push(l);e.bindEvents(l,f)},getDirectionsInfo:function(){var a=[];this.get("direction",function(b){b.forEach(function(b,d){var e=b.getDirections();e.hasOwnProperty("routes")&&"undefined"!==typeof e.routes[0]&&"undefined"!==typeof e.routes[0].legs&&(a[d]=[],e.routes[0].legs.forEach(function(b,c){a[d].push({from:b.start_address,to:b.end_address,distance:b.distance,duration:b.duration})}))})});
return a},streetView:function(a,b){var c=b.hasOwnProperty("streetViewObj")?b.streetViewObj:{},d={},d={};"function"===typeof a.getStreetView&&(c.hasOwnProperty("position")?(d=q(c.position,!0),c.position="object"===typeof d?a.getCenter():d):c.position=a.getCenter(),c.hasOwnProperty("pov")&&(c.pov=g.extend({},{heading:0,pitch:0,zoom:1},c.pov)),d=a.getStreetView(),d.setOptions(c),c.hasOwnProperty("event")&&this.bindEvents(d,c.event),c.hasOwnProperty("visible")&&d.setVisible(c.visible))},places:function(a,
b){var c=this,d={},d=b.hasOwnProperty("places")?b.places:{},e=g.extend({location:a.getCenter(),radius:100},d);e.location=q(e.location,!0);"undefined"!==typeof google.maps.places&&(d=new google.maps.places.PlacesService(a),d.nearbySearch(e,function(b,d){d===google.maps.places.PlacesServiceStatus.OK&&(c._places.push(b),e.hasOwnProperty("createMarker")&&!0===e.createMarker&&b.forEach(function(b){b.hasOwnProperty("geometry")&&c._markers.push(new google.maps.Marker({map:a,position:b.geometry.location}))}),
e.hasOwnProperty("callback")&&"function"===typeof e.callback&&e.callback.call(b))}))},geoLocation:function(a,b){try{var c=this,d={},e=navigator.geolocation;e&&(b.hasOwnProperty("geolocation")&&(d=g.extend({},{maximumAge:6E5,timeout:3E3,enableHighAccuracy:!1},b.geolocation)),!0!==b.autoLocation&&"function"!==typeof b.autoLocation||e.watchPosition(function(d){"undefined"!==typeof d&&"coords"in d&&"latitude"in d.coords&&"longitude"in d.coords&&(a.panTo(new google.maps.LatLng(d.coords.latitude,d.coords.longitude)),
"function"===typeof b.autoLocation&&b.autoLocation.call(c,d))},function(a){console.error(a)},d))}catch(f){}},panTo:function(a){var b=this.map,c={},d={};null!==b&&"undefined"!==typeof b&&(c=q(a,!0),"string"===typeof c?(d=new google.maps.Geocoder,d.geocode({address:c},function(a,c){c===google.maps.GeocoderStatus.OK&&"function"===typeof b.panTo&&Array.isArray(a)&&a.length?a[0].hasOwnProperty("geometry")&&b.panTo(a[0].geometry.location):console.error(c)})):"function"===typeof b.panTo&&b.panTo(c));return g(this.container)},
close:function(a,b){var c=this.get(a),d={},e="";c.hasOwnProperty("map")&&delete c.map;Array.isArray(c)?d[a]=c:d=c;try{for(e in d)Array.isArray(d[e])&&d[e].forEach(function(a){a.hasOwnProperty("infoWindow")&&"function"===typeof a.infoWindow.close&&a.infoWindow.close()});"function"===typeof b&&b.call(this)}catch(f){console.warn(f)}finally{return g(this.container)}},clear:function(a,b){function c(a,b){"function"===typeof a.setMap&&f._directionsMarkers[b].setMap(null)}function d(a){"direction"===m&&(h.forEach(c),
f._directionsMarkers.filter(function(a){return"undefined"!==typeof a}));"function"===typeof a.set&&a.set("visible",!1);"function"===typeof a.setMap&&a.setMap(null);-1!==f[p].indexOf(a)&&delete f[p][f[p].indexOf(a)]}function e(a){return"undefined"!==typeof a}var f=this,h=f._directionsMarkers,l=f.get(a),k={},p="",m="";"undefined"!==typeof l&&"undefined"!==typeof l.map&&delete l.map;Array.isArray(l)?k[a]=l:k=l;try{for(m in k)Array.isArray(k[m])&&(p="_"+m.toString().toLowerCase()+"s",k[m].forEach(d),
f[p]=f[p].filter(e));"function"===typeof b&&b.call(this)}catch(w){console.warn(w)}finally{return g(f.container)}},get:function(a,b){function c(b){(0===a[f].length||-1!==a[f].indexOf(k)||"undefined"!==typeof b.id&&0<b.id.length&&-1!==b.id.indexOf(a[f]))&&e[f].push(b)}var d=[],e={},f={},h="",l="",k=0;"undefined"===typeof a&&(a={marker:[],label:[],polygon:[],polyline:[],circle:[],direction:[],kml:[],cluster:[],bound:[]});try{if("string"===typeof a)if(-1!==a.indexOf(","))for(d=a.replace(/\s/gi,"").split(","),
k=0;k<d.length;k+=1)l=d[k].toString().toLowerCase(),"map"===l?e[l]=this.map:(h="_"+l+"s",e[l]=this[h]);else"map"===a.toString().toLowerCase()?e=this.map:(h="_"+a.toString().toLowerCase()+"s",e=this[h]);else{for(f in a)Array.isArray(a[f])&&(h="_"+f.toString().toLowerCase()+"s",Array.isArray(this[h])&&(e[f]=[],this[h].forEach(c)));e.map=this.map}"function"===typeof b&&b.call(this,e);return e}catch(g){console.error(g)}finally{return e}},modify:function(a){var b=[],c=[["kml","kml"],["marker","placeMarkers"],
["direction","directionService"],["polyline","drawPolyline"],["polygon","drawPolygon"],["circle","drawCircle"],["streetView","streetView"],["markerFitBounds","markerFitBounds"],["places","places"]],d=0,e=this.map;if("undefined"!==typeof a){for(d=0;d<c.length;d+=1)a.hasOwnProperty(c[d][0])&&b.push(c[d][1]);if(null!==e){if(b.length)for(d=0;d<b.length;d+=1)"function"===typeof this[b[d]]&&("streetView"===b[d]&&(a.streetViewObj=a.streetView,delete a.streetView),this[b[d]](e,a,"modify"));else e.setOptions(a);
a.hasOwnProperty("event")&&this.bindEvents(e,a.event);google.maps.event.trigger(e,"resize")}}return g(this.container)},query:function(a,b){var c=this,d=new google.maps.Geocoder,e=q(a),f={};"string"===typeof e?f.address=e:f={location:{lat:parseFloat(e.lat,10),lng:parseFloat(e.lng,10)}};d.geocode(f,function(d,e){try{if(e===google.maps.GeocoderStatus.OVER_QUERY_LIMIT)setTimeout(function(){c.query(a,b)},c.interval);else if(e===google.maps.GeocoderStatus.OK&&Array.isArray(d)){if(0<d.length&&d[0].hasOwnProperty("geometry"))if("function"===
