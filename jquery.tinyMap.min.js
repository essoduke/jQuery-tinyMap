...
G={autoLocation:!1,center:[24,121],infoWindowAutoClose:!0,interval:200,loading:"\u8b80\u53d6\u4e2d&hellip;",notFound:"\u627e\u4e0d\u5230\u67e5\u8a62\u7684\u5730\u9ede",zoom:8},B={},B={greyscale:[{featureType:"all",stylers:[{saturation:-100},{gamma:.5}]}]};A.prototype={VERSION:"3.3.3",formatSize:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Size(a[0],a[1]):a},formatPoint:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Point(a[0],a[1]):a},overlay:function(){var a=
...
this,e={},g={maxZoom:null,gridSize:60},h=Array.isArray(c.marker)?c.marker:[];d.options.hasOwnProperty("markerCluster")&&"function"===typeof MarkerClusterer&&(g=f.extend({},g,c.markerCluster),d._clusters=new MarkerClusterer(a,[],g),g.hasOwnProperty("event")&&d.bindEvents(d._clusters,g.event));h.forEach(function(g){var h=p(g.addr,!0),q=d.markerIcon(g),l={map:a,animation:null},y=!0,t=!1,u={},v={},F="undefined"!==typeof g.id?g.id:!1,l=f.extend({},l,g);"modify"===b&&F&&d.get({marker:[F]},function(a){!a.marker||
g.hasOwnProperty("forceInsert")&&!0===g.forceInsert||(g=f.extend(a.marker[0],g),"function"===typeof d._clusters.removeMarker&&d._clusters.removeMarker(a.marker[0]),y=!1,t=!0)});g.hasOwnProperty("title")&&(l.title=g.title.toString().replace(/<([^>]+)>/g,""));f.isEmptyObject(q)||(l.icon=q);g.hasOwnProperty("animation")&&"string"===typeof g.animation&&(l.animation=google.maps.Animation[g.animation.toUpperCase()]);"string"===typeof h?(e=new google.maps.Geocoder,e.geocode({address:h},function(e,h){h===
