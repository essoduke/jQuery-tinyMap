...
"infoWindow")&&google.maps.event.addListener(b,"click",function(){var a=0,d={};if(g(c.options,"infoWindowAutoClose")&&!0===c.options.infoWindowAutoClose)for(a=0;a<c._markers.length;a+=1)d=c._markers[a],g(d,"infoWindow")&&"function"===typeof d.infoWindow.close&&d.infoWindow.close();b.infoWindow.open(c.map,b)})},streetView:function(b,a){var c={},d=g(a,"streetView")?a.streetView:{},e={heading:0,pitch:0,zoom:1},f={};"function"===typeof b.getStreetView&&g(a,"streetView")&&(c=b.getStreetView(),g(d,"position")?
(f=p(d.position,!0),d.position="object"!==typeof f?b.getCenter():f):d.position=b.getCenter(),g(d,"pov")&&(d.pov=h.extend({},e,d.pov)),g(d,"visible")&&c.setVisible(d.visible),c.setOptions(d),g(d,"event")&&this.bindEvents(c,d.event))},panto:function(b){var a={},a={},c=this.map;null!==c&&q!==c&&(a=p(b,!0),"string"===typeof b?(a=new google.maps.Geocoder,a.geocode({address:b},function(a,b){b===google.maps.GeocoderStatus.OK?"function"===typeof c.panTo&&a.length&&c.panTo(a[0].geometry.location):console.error(b)})):
"function"===typeof c.panTo&&c.panTo(a))},clear:function(b){for(var a=[],c="",d=0,e=0,a="string"===typeof b?b.split(","):h.isArray(b)?b:"marker circle polygon polyline direction kml".split(" "),d=0;d<a.length;d+=1){c="_"+h.trim(a[d].toString().toLowerCase())+"s";if(q!==this[c]&&this[c].length){for(e=0;e<this[c].length;e+=1)this.map===this[c][e].getMap()&&(this[c][e].set("visible",!1),this[c][e].set("directions",null),this[c][e].setMap(null));this[c].length=0}if("direction"===a[d])for(e=0;e<this._directionsMarkers.length;e+=
1)this._directionsMarkers[e].setMap(null)}},modify:function(b){var a=[],c=[["kml","kml"],["marker","markers"],["direction","direction"],["polyline","drawPolyline"],["polygon","drawPolygon"],["circle","drawCircle"],["zoom","setZoom"],["streetView","streetView"]],d=0,e=this.map;if(q!==b){for(d=0;d<c.length;d+=1)g(b,c[d][0])&&a.push(c[d][1]);if(null!==e){if(a.length)for(d=0;d<a.length;d+=1){if("function"===typeof this[a[d]])this[a[d]](e,b,"modify")}else e.setOptions(b);g(b,"event")&&this.bindEvents(e,
b.event)}}},destroy:function(){var b=h(this.container);h.data(b.get(0),"tinyMap",null);if(b.length)return b.empty()},geoLocation:function(b,a){var c=navigator.geolocation;c&&!0===a.autoLocation&&c.getCurrentPosition(function(a){a&&g(a,"coords")&&b.panTo(new google.maps.LatLng(a.coords.latitude,a.coords.longitude))},function(a){console.error(a)},{maximumAge:6E5,timeout:3E3,enableHighAccuracy:!1})},init:function(){var b=this,a={};"string"===typeof b.options.center?(a=new google.maps.Geocoder,a.geocode({address:b.options.center},
function(a,d){try{d===google.maps.GeocoderStatus.OVER_QUERY_LIMIT?b.init():d===google.maps.GeocoderStatus.OK&&0!==a.length?q!==a[0]&&g(a[0],"geometry")&&(b.googleMapOptions.center=a[0].geometry.location,b.map=new google.maps.Map(b.container,b.googleMapOptions),google.maps.event.addListenerOnce(b.map,"idle",function(){b.overlay()}),b.bindEvents(b.map,b.options.event)):console.error(d)}catch(e){console.error(e)}})):(b.map=new google.maps.Map(b.container,b.googleMapOptions),google.maps.event.addListenerOnce(b.map,
"idle",function(){b.overlay()}),b.bindEvents(b.map,b.options.event))}};h.fn.tinyMap=function(b){var a=arguments,c=[],d={};return"string"===typeof b?(this.each(function(){d=h.data(this,"tinyMap");d instanceof u&&"function"===typeof d[b]&&(c=d[b].apply(d,Array.prototype.slice.call(a,1)))}),q!==c?c:this):this.each(function(){h.data(this,"tinyMap")||h.data(this,"tinyMap",new u(this,b))})}})(jQuery,window,document);
