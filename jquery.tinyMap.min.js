...
p={},w=[],r={},m="",l=0,s=0;f.origin=q(b.from,!0);f.destination=q(b.to,!0);g(b,"travel")&&google.maps.TravelMode[b.travel.toString().toUpperCase()]&&(f.travelMode=google.maps.TravelMode[b.travel.toString().toUpperCase()]);g(b,"panel")&&(e=h(b.panel));if(g(b,"waypoint")&&h.isArray(b.waypoint)){l=0;for(s=b.waypoint.length;l<s;l+=1)p={},"string"===typeof b.waypoint[l]||h.isArray(b.waypoint[l])?p={location:q(b.waypoint[l],!0),stopover:!0}:(g(b.waypoint[l],"location")&&(p.location=q(b.waypoint[l].location,
!0)),p.stopover=g(b.waypoint[l],"stopover")?b.waypoint[l].stopover:!0),w.push(b.waypoint[l].text||b.waypoint[l].toString()),k.push(p);f.waypoints=k}d.route(f,function(d,f){var e=0,h=0;if(f===google.maps.DirectionsStatus.OK){e=d.routes[0].legs;g(b,"autoViewport")&&(n.preserveViewport=!1===b.autoViewport?!0:!1);try{for(g(b,"fromText")&&(e[0].start_address=b.fromText),g(b,"toText")&&(1===e.length?e[0].end_address=b.toText:e[e.length-1].end_address=b.toText),1===e.length?(r=e[0].end_location,m=e[0].end_address):
(r=e[e.length-1].end_location,m=e[e.length-1].end_address),g(b,"icon")&&(n.suppressMarkers=!0,g(b.icon,"from")&&"string"===typeof b.icon.from&&a.directionServiceMarker(e[0].start_location,{icon:b.icon.from,text:e[0].start_address}),g(b.icon,"to")&&"string"===typeof b.icon.to&&a.directionServiceMarker(r,{icon:b.icon.to,text:m})),h=0;h<e.length-1;h+=1)e[h].end_address=w[h],g(b,"icon")&&g(b.icon,"waypoint")&&a.directionServiceMarker(e[h].start_location,{icon:b.icon.waypoint,text:e[h].start_address})}catch(k){}a.bindEvents(c,
